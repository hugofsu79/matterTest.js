((this || self || window).Two = (function (e) {
  var p;
  p =
  ...
  var t = Object.prototype.toString,
    B = {
      ...
      isEmpty: function (e) {
        return (
          null == e ||
          (g && (B.isArray(e) || B.isString(e) || B.isArguments(e))
            ? 0 === e.length
            : 0 === B.keys(e).length)
        );
      },
      ...
      range: function (e, t, i) {
        ...
        for (
          var r = Math.max(Math.ceil((t - e) / i), 0), n = Array(r), s = 0;
          s < r;
          s++, e += i
        )
          n[s] = e;
      ...
      each: function (e, t, i) {
        for (
          var r = i || this, n = !g(e) && B.keys(e), s = (n || e).length, o = 0;
          o < s;
          o++
        ) {
          var a = n ? n[o] : o;
          ...
          for (var r = 0; r < t.length; r++)
            (i = p[t[r] + "RequestAnimationFrame"] || i),
              (e =
                ...
                p[t[r] + "CancelRequestAnimationFrame"] ||
                e);
          i =
            i ||
            function (e, t) {
    ...
    O = (p.Two = function (e) {
      ...
      if (
        ...
        B.isElement(t.domElement) ||
          (this.renderer.setSize(t.width, t.height, this.ratio),
          (this.width = t.width),
  ...
  B.extend(O, {
    ...
    Utils: B.extend(B, {
      ...
      defineProperty: function (e) {
        var t = "_" + e,
          i = "_flag" + e.charAt(0).toUpperCase() + e.slice(1);
      ...
      release: function (e) {
        if (B.isObject(e))
          return (
            ...
            e.vertices &&
              (B.isFunction(e.vertices.unbind) && e.vertices.unbind(),
      ...
      applySvgAttributes: function (e, t, i) {
        ...
        if (p.getComputedStyle) {
          ...
          for (r = h.length; r--; )
            (s = h[(n = h[r])]), B.isUndefined(s) || (a[n] = s);
        }
        ...
        B.extend(a, l, c),
        (a.visible =
          !(B.isUndefined(a.display) && /none/i.test(a.display)) ||
          (B.isUndefined(a.visibility) && /hidden/i.test(a.visibility))),
        a))
          switch (((s = a[n]), n)) {
            case "transform":
              ...
              t.translation.set(u.translateX, u.translateY),
                (t.rotation = u.rotation),
                (t.scale = new O.Vector(u.scaleX, u.scaleY));
              var f = parseFloat((a.x + "").replace("px")),
                g = parseFloat((a.y + "").replace("px"));
            ...
            case "stroke":
              /url\(\#.*\)/i.test(s)
                ? (t[n] = this.getById(s.replace(/url\(\#(.*)\)/i, "$1")))
                : (t[n] = /none/i.test(s) ? "transparent" : s);
              break;
            case "id":
              t.id = s;
              break;
      ...
      read: {
        ...
        path: function (e, t) {
          ...
          B.each(m.slice(0), function (e, t) {
            ...
            for (o = 0; o < f.length; o++)
              if ((i = f[o]).indexOf(".") !== i.lastIndexOf(".")) {
                for (
                  n = (r = i.split("."))[0] + "." + r[1],
                    f.splice(o, 1, n),
                    s = 2;
          ...
          if (
                ...
                case "l":
                  (A = void 0),
                    ...
                    (i = new O.Anchor(
                      ...
                      void 0,
                      void 0,
                      /m/i.test(p) ? O.Commands.move : O.Commands.line
                    )),
                    R && i.addSelf(M),
                    (M = i);
                  break;
                ...
                case "s":
                  (s = M.x),
                    ...
                    R &&
                      ...
                      (d += s),
                      (u += o)),
                    B.isObject(M.controls) || O.Anchor.AppendCurveProperties(M),
                    M.controls.right.set(a - M.x, l - M.y),
                    (i = new O.Anchor(
                      d,
                      u,
                      c - d,
            ...
            (i = new O.Path(T, P, void 0, !0).noStroke()).fill = "black";
            ...
            return (
              ...
              O.Utils.applySvgAttributes.call(this, e, i, t),
              i
            );
          }
        },
        ...
        rect: function (e, t) {
          ...
          var n = parseFloat(e.getAttribute("x")) || 0,
            ...
            l = o / 2,
            c = a / 2,
            h = new O.Rectangle(n + l, s + c, o, a).noStroke();
          return (
            (h.fill = "black"),
        ...
        "rounded-rect": function (e, t) {
          var i = parseFloat(e.getAttribute("x")) || 0,
            ...
            c = a / 2,
            h = new O.Vector(n, s),
            d = new O.RoundedRectangle(i + l, r + c, o, a, h).noStroke();
          return (
            (d.fill = "black"),
        ...
        lineargradient: function (e, t) {
          for (
            ...
            if (B.isNull(f))
              f =
                (h = !!p && p.match(/stop\-color\:\s?([\#a-fA-F0-9]*)/)) &&
                1 < h.length
                  ? h[1]
                  : void 0;
            if (B.isNull(g))
              g =
                (h = !!p && p.match(/stop\-opacity\:\s?([0-9\.\-]*)/)) &&
                1 < h.length
                  ? parseFloat(h[1])
                  : 1;
        ...
        radialgradient: function (e, t) {
          ...
          for (
            ...
            if (B.isNull(g))
              g =
                (d = !!m && m.match(/stop\-color\:\s?([\#a-fA-F0-9]*)/)) &&
                1 < d.length
                  ? d[1]
                  : void 0;
            if (B.isNull(p))
              p =
                (d = !!m && m.match(/stop\-opacity\:\s?([0-9\.\-]*)/)) &&
                1 < d.length
                  ? parseFloat(d[1])
                  : 1;
      ...
      subdivide: function (e, t, i, r, n, s, o, a, l) {
        ...
        if (w(e - o) < 0.001 && w(t - a) < 0.001) return [new O.Anchor(o, a)];
        for (var h = [], d = 0; d < c; d++) {
          var u = d / c,
            f = x(u, e, i, n, o),
            g = x(u, t, r, s, a);
      ...
      getComponentOnCubicBezier: function (e, t, i, r, n) {
        var s = 1 - e;
        return (
          s * s * s * t + 3 * s * s * e * i + 3 * s * e * e * r + e * e * e * n
        );
      },
        ...
        for (
          ...
          if (
            ...
            (g = c * c - 4 * h * l),
              (p = Math.sqrt(g)),
              g < 0 ||
                (0 < (u = (-c + p) / (2 * l)) && u < 1 && m.push(u),
                0 < (f = (-c - p) / (2 * l)) && f < 1 && m.push(f));
      ...
      getCurveFromPoints: function (e, t) {
        for (var i = e.length, r = i - 1, n = 0; n < i; n++) {
          ...
          var o = t ? y(n - 1, i) : f(n - 1, 0),
            ...
            h = e[a];
          m(l, c, h),
            (c.command = 0 === n ? O.Commands.move : O.Commands.curve);
        }
      },
      ...
      getReflection: function (e, t, i) {
        return new O.Vector(
          2 * e.x - (t.x + e.x) - (i ? e.x : 0),
          2 * e.y - (t.y + e.y) - (i ? e.y : 0)
        );
      },
      getAnchorsFromArcData: function (e, t, o, a, l, c, h) {
        ...
        return B.map(B.range(d), function (e) {
          ...
          var i = t * c + l,
            ...
            s = new O.Anchor(r, n);
          return (
            O.Anchor.AppendCurveProperties(s), (s.command = O.Commands.line), s
          );
        });
      },
      lerp: function (e, t, i) {
      ...
      Events: {
        ...
        off: function (e, t) {
          ...
          for (
            var i = e ? [e] : B.keys(this._events), r = 0, n = i.length;
            r < n;
            r++
          ) {
            e = i[r];
  ...
  B.extend(O.prototype, O.Utils.Events, {
    ...
    play: function () {
      return (
        O.Utils.setPlaying.call(this, !0), A.init(), this.trigger(O.Events.play)
      );
    },
    pause: function () {
    ...
    update: function () {
      var e = !!this._lastFrame,
        t = s.now();
      e && (this.timeDelta = parseFloat((t - this._lastFrame).toFixed(3))),
        (this._lastFrame = t);
      var i = this.width,
        r = this.height,
        n = this.renderer;
      return (
        (i === n.width && r === n.height) || n.setSize(i, r, this.ratio),
        this.trigger(O.Events.update, this.frameCount, this.timeDelta),
        this.render()
      );
    },
    render: function () {
      return (
        this.renderer.render(), this.trigger(O.Events.render, this.frameCount++)
      );
    },
    add: function (e) {
      var t = e;
    ...
    makeCurve: function (e) {
      ...
      return (
        a.center().translation.set(l.left + l.width / 2, l.top + l.height / 2),
        this.scene.add(a),
        a
      );
    },
  ...
  (function (i) {
    ...
    var t = {
        ...
        copy: function (e) {
          return (
            (this._x = e.x), (this._y = e.y), this.trigger(i.Events.change)
          );
        },
        clear: function () {
  ...
  (function (d) {
    var u = d.Commands,
      ...
      t = (d.Anchor = function (e, t, i, r, n, s, o) {
        ...
        var a = f.isNumber(i),
          ...
          c = f.isNumber(n),
          h = f.isNumber(s);
        (a || l || c || h) && d.Anchor.AppendCurveProperties(this),
          ...
          Object.defineProperty(e, "relative", {
            ...
            set: function (e) {
              return this._relative == e
                ? this
                : ((this._relative = !!e), this.trigger(d.Events.change));
            },
          }),
    ...
    var i = {
      ...
      listen: function () {
        return (
          f.isObject(this.controls) || d.Anchor.AppendCurveProperties(this),
      ...
      copy: function (e) {
        return (
          ...
          f.isBoolean(e.relative) && (this.relative = e.relative),
    ...
    a.extend(e, {
      ...
      Multiply: function (e, t, i) {
        ...
        var a = e[0],
          ...
          C = t[8];
        return (
          ((i = i || new T.Array(9))[0] = a * m + l * _ + c * w),
          (i[1] = a * v + l * x + c * S),
          (i[2] = a * y + l * b + c * C),
          (i[3] = h * m + d * _ + u * w),
          (i[4] = h * v + d * x + u * S),
      ...
      a.extend(e.prototype, T.Utils.Events, {
        ...
        set: function (e) {
          var t = e;
          return (
            1 < arguments.length && (t = a.toArray(arguments)),
            (this.elements[0] = t[0]),
            (this.elements[1] = t[1]),
            (this.elements[2] = t[2]),
            (this.elements[3] = t[3]),
  ...
  (function (P) {
    var R = P.Utils.mod,
      ...
      a = {
          ...
          for (var i, r = e.length, n = r - 1, s = "", o = 0; o < r; o++) {
            ...
            switch (b.command) {
              ...
              case P.Commands.curve:
                (u = (C.controls && C.controls.right) || P.Vector.zero),
                  (f = (b.controls && b.controls.left) || P.Vector.zero),
                  (c = C.relative
                    ? ((l = E(u.x + C.x)), E(u.y + C.y))
                    : ((l = E(u.x)), E(u.y))),
                  (d = b.relative
                    ? ((h = E(f.x + b.x)), E(f.y + b.y))
                    : ((h = E(f.x)), E(f.y))),
                  (a =
                    (0 === o ? P.Commands.move : P.Commands.curve) +
                    " " +
                    l +
                    " " +
                    c +
            ...
            n <= o &&
              ...
              (b.command === P.Commands.curve &&
                ((A = i),
                (g = (b.controls && b.controls.right) || b),
                (p = (A.controls && A.controls.left) || A),
                (c = b.relative
                ...
                (a +=
                  ...
                  " " +
                  (M = E(A.y)))),
              b.command !== P.Commands.close && (a += " Z")),
              (s += a + " ");
          }
          return s;
        },
        getClip: function (e) {
          ...
          if (!t) {
            ...
            (t = e._renderer.clip = a.createElement("clipPath")),
        ...
        group: {
          ...
          render: function (e) {
            if ((this._update(), 0 === this._opacity && !this._flagOpacity))
              return this;
            this._renderer.elem ||
              ((this._renderer.elem = a.createElement("g", {
                id: this.id,
              })),
            ...
            return (
              ...
              this._flagAdditions &&
                this.additions.forEach(a.group.appendChild, i),
              this._flagSubtractions &&
                this.subtractions.forEach(a.group.removeChild, i),
              this._flagOrder && this.children.forEach(a.group.orderChild, i),
              this._flagMask &&
                (this._mask
                  ? this._renderer.elem.setAttribute(
                      "clip-path",
          ...
          render: function (e) {
            ...
            if (
              (this._fill &&
                ...
                (this._fill._update(),
                a[this._fill._renderer.type].render.call(this._fill, e, !0)),
              this._flagFill &&
                (t.fill =
              ...
              this._stroke &&
                ...
                a[this._stroke._renderer.type].render.call(
                  this._stroke,
                  e,
                  !0
                )),
              ...
              this._flagClassName && (t.class = this._className),
              this._flagVisible &&
              ...
              this._renderer.elem
                ? a.setAttributes(this._renderer.elem, t)
                : ((t.id = this.id),
                  (this._renderer.elem = a.createElement("path", t)),
                  e.appendChild(this._renderer.elem)),
              this._flagClip)
            ) {
              ...
              this._clip
                ...
                : (r.removeAttribute("id"),
                  ...
                  this.parent._renderer.elem.appendChild(n));
            }
        ...
        text: {
          render: function (e) {
            ...
            if (
              ...
              this._flagAlignment &&
                (t["text-anchor"] =
                  a.alignments[this._alignment] || this._alignment),
              this._flagBaseline &&
              ...
              this._flagDecoration && (t["text-decoration"] = this._decoration),
              this._fill &&
                this._fill._renderer &&
                (this._fill._update(),
                a[this._fill._renderer.type].render.call(this._fill, e, !0)),
              ...
              this._renderer.elem
                ? a.setAttributes(this._renderer.elem, t)
                : ((t.id = this.id),
                  (this._renderer.elem = a.createElement("text", t)),
        ...
        "linear-gradient": {
          render: function (e, t) {
            ...
            if (
              ...
              this._renderer.elem
                ? a.setAttributes(this._renderer.elem, i)
                : ((i.id = this.id),
                  (i.gradientUnits = "userSpaceOnUse"),
                  (this._renderer.elem = a.createElement("linearGradient", i)),
                  e.defs.appendChild(this._renderer.elem)),
              this._flagStops)
            ) {
              var r =
              ...
              for (var n = 0; n < this.stops.length; n++) {
                var s = this.stops[n],
                  o = {};
                s._flagOffset && (o.offset = 100 * s._offset + "%"),
                  s._flagColor && (o["stop-color"] = s._color),
                  s._flagOpacity && (o["stop-opacity"] = s._opacity),
                  s._renderer.elem
                    ? a.setAttributes(s._renderer.elem, o)
                    : (s._renderer.elem = a.createElement("stop", o)),
                  r && this._renderer.elem.appendChild(s._renderer.elem),
                  s.flagReset();
              }
            }
            return this.flagReset();
          ...
          render: function (e, t) {
            ...
            if (
              ...
              this._renderer.elem
                ...
                : ((i.id = this.id),
                  (i.gradientUnits = "userSpaceOnUse"),
                  (this._renderer.elem = a.createElement("radialGradient", i)),
                  e.defs.appendChild(this._renderer.elem)),
              this._flagStops)
            ) {
              var r =
        ...
        texture: {
          render: function (e, t) {
            ...
            if (
              ((this._flagOffset || this._flagLoaded || this._flagScale) &&
                ...
                n &&
                  ...
                  this._scale instanceof P.Vector
                    ? ((i.x *= this._scale.x), (i.y *= this._scale.y))
                    : ((i.x *= this._scale), (i.y *= this._scale))),
                0 < i.x && (i.x *= -1),
                0 < i.y && (i.y *= -1)),
              ...
              this._scale instanceof P.Vector
                ? ((i.width *= this._scale.x), (i.height *= this._scale.y))
                : ((i.width *= this._scale), (i.height *= this._scale));
            }
            return (
              (this._flagScale || this._flagLoaded) &&
                (this._renderer.image
                  ? s.isEmpty(r) || a.setAttributes(this._renderer.image, r)
                  : (this._renderer.image = a.createElement("image", r))),
              this._renderer.elem
                ? s.isEmpty(i) || a.setAttributes(this._renderer.elem, i)
                : ((i.id = this.id),
                  (i.patternUnits = "userSpaceOnUse"),
                  (this._renderer.elem = a.createElement("pattern", i)),
                  e.defs.appendChild(this._renderer.elem)),
              this._renderer.elem &&
                this._renderer.image &&
      ...
      e = (P[P.Types.svg] = function (e) {
        (this.domElement = e.domElement || a.createElement("svg")),
          (this.scene = new P.Group()),
          ((this.scene.parent = this).defs = a.createElement("defs")),
      ...
      Z = {
        ...
        group: {
          ...
          render: function (e) {
            ...
            this._renderer.opacity =
              this._opacity * (i && i._renderer ? i._renderer.opacity : 1);
            var r = Q(t),
              n = this._mask;
            if (
              (this._renderer.context || (this._renderer.context = {}),
              (this._renderer.context.ctx = e),
              r || (e.save(), e.transform(t[0], t[3], t[1], t[4], t[2], t[5])),
              n && Z[n._renderer.type].render.call(n, e, !0),
        ...
        path: {
          render: function (e, t, i) {
            ...
            if (
              ...
              (s = this._linewidth),
              (o = this._fill),
              (a = this._opacity * this.parent._renderer.opacity),
              (l = this._visible),
              (c = this._cap),
              (h = this._join),
              (d = this._miter),
              (u = this._closed),
              (p = (g = (f = this._renderer.vertices).length) - 1),
              (F = Q(r)),
              (I = this.dashes),
              (B = this._clip),
              !t && (!l || B))
              ...
              return this;
            F || (e.save(), e.transform(r[0], r[3], r[1], r[4], r[2], r[5])),
              o &&
                (X.isString(o)
                  ? (e.fillStyle = o)
                  : (Z[o._renderer.type].render.call(o, e),
                    (e.fillStyle = o._renderer.effect))),
              n &&
                (X.isString(n)
                  ? (e.strokeStyle = n)
                  : (Z[n._renderer.type].render.call(n, e),
                    (e.strokeStyle = n._renderer.effect))),
              s && (e.lineWidth = s),
              d && (e.miterLimit = d),
              h && (e.lineJoin = h),
              c && (e.lineCap = c),
            ...
            for (var U = 0; U < f.length; U++)
              switch (((_ = f[U]), (E = H(_.x)), (T = H(_.y)), _.command)) {
                ...
                case W.Commands.curve:
                  (v = u ? z(U - 1, g) : Math.max(U - 1, 0)),
                    (m = u ? z(U + 1, g) : Math.min(U + 1, p)),
                    (y = f[v]),
                    (x = f[m]),
                    (k = (y.controls && y.controls.right) || W.Vector.zero),
                    (M = (_.controls && _.controls.left) || W.Vector.zero),
                    (A = y._relative
                      ? ((C = k.x + H(y.x)), k.y + H(y.y))
                      : ((C = H(k.x)), H(k.y))),
                    (S = _._relative
                      ? ((w = M.x + H(_.x)), M.y + H(_.y))
                      : ((w = H(M.x)), H(M.y))),
                    e.bezierCurveTo(C, A, w, S, E, T),
                    p <= U &&
                      u &&
                      ((x = b),
                      (P = (_.controls && _.controls.right) || W.Vector.zero),
                      (R = (x.controls && x.controls.left) || W.Vector.zero),
                      (A = _._relative
                        ? ((C = P.x + H(_.x)), P.y + H(_.y))
                        : ((C = H(P.x)), H(P.y))),
                      (S = x._relative
                        ? ((w = R.x + H(x.x)), R.y + H(x.y))
                        : ((w = H(R.x)), H(R.y))),
                      (E = H(x.x)),
                      (T = H(x.y)),
                      e.bezierCurveTo(C, A, w, S, E, T));
            ...
            return (
              ...
              B ||
                i ||
                (Z.isHidden.test(o) ||
                  ((O = o._renderer && o._renderer.offset) &&
                    (e.save(),
                    e.translate(-o._renderer.offset.x, -o._renderer.offset.y),
                    e.scale(o._renderer.scale.x, o._renderer.scale.y)),
                  e.fill(),
                  O && e.restore()),
                Z.isHidden.test(n) ||
                  ((O = n._renderer && n._renderer.offset) &&
                    (e.save(),
                    e.translate(-n._renderer.offset.x, -n._renderer.offset.y),
                    e.scale(n._renderer.scale.x, n._renderer.scale.y),
                    (e.lineWidth = s / n._renderer.scale.x)),
                  e.stroke(),
                  O && e.restore())),
              F || e.restore(),
              B && !i && e.clip(),
        ...
        text: {
          render: function (e, t, i) {
            ...
            return t || (p && !_)
              ? (m ||
                  (e.save(), e.transform(h[0], h[3], h[1], h[4], h[2], h[5])),
                v ||
                  (e.font = [
                    this._style,
                    this._weight,
                ...
                (e.textAlign =
                  Z.alignments[this._alignment] || this._alignment),
                (e.textBaseline = this._baseline),
                f &&
                  (X.isString(f)
                    ? (e.fillStyle = f)
                    : (Z[f._renderer.type].render.call(f, e),
                      (e.fillStyle = f._renderer.effect))),
                d &&
                  (X.isString(d)
                    ? (e.strokeStyle = d)
                    : (Z[d._renderer.type].render.call(d, e),
                      (e.strokeStyle = d._renderer.effect))),
                u && (e.lineWidth = u),
                ...
                _ ||
                  i ||
                  (Z.isHidden.test(f) ||
                    (f._renderer && f._renderer.offset
                      ? ((l = H(f._renderer.scale.x)),
                        (c = H(f._renderer.scale.y)),
                        e.save(),
                        e.translate(
                          -H(f._renderer.offset.x),
                          -H(f._renderer.offset.y)
                        ),
                        e.scale(l, c),
                        (r = this._size / f._renderer.scale.y),
                        (n = this._leading / f._renderer.scale.y),
                        (e.font = [
                          this._style,
                          this._weight,
                          H(r) + "px/",
                        ...
                        (s = f._renderer.offset.x / f._renderer.scale.x),
                        (o = f._renderer.offset.y / f._renderer.scale.y),
                        e.fillText(this.value, H(s), H(o)),
                        e.restore())
                      : e.fillText(this.value, 0, 0)),
                  Z.isHidden.test(d) ||
                    (d._renderer && d._renderer.offset
                      ? ((l = H(d._renderer.scale.x)),
                        (c = H(d._renderer.scale.y)),
                        e.save(),
                        e.translate(
                          -H(d._renderer.offset.x),
                          -H(d._renderer.offset.y)
                        ),
                        e.scale(l, c),
                        (r = this._size / d._renderer.scale.y),
                        (n = this._leading / d._renderer.scale.y),
                        (e.font = [
                          this._style,
                          this._weight,
                          H(r) + "px/",
                        ...
                        (s = d._renderer.offset.x / d._renderer.scale.x),
                        (o = d._renderer.offset.y / d._renderer.scale.y),
                        (a = u / d._renderer.scale.x),
                        (e.lineWidth = H(a)),
                        e.strokeText(this.value, H(s), H(o)),
                        e.restore())
                      : e.strokeText(this.value, 0, 0))),
                m || e.restore(),
                _ && !i && e.clip(),
                y && 0 < y.length && e.setLineDash(Y),
                this.flagReset())
        ...
        "linear-gradient": {
          render: function (e) {
            if (
              (this._update(),
              !this._renderer.effect || this._flagEndPoints || this._flagStops)
            ) {
              this._renderer.effect = e.createLinearGradient(
                this.left._x,
                this.left._y,
                this.right._x,
                this.right._y
        ...
        "radial-gradient": {
          render: function (e) {
            if (
              ...
              this._renderer.effect = e.createRadialGradient(
                this.center._x,
                this.center._y,
                0,
                this.focal._x,
        ...
        texture: {
          render: function (e) {
            ...
            return (
              ...
              (this._flagOffset || this._flagLoaded || this._flagScale) &&
                (this._renderer.offset instanceof W.Vector ||
                  (this._renderer.offset = new W.Vector()),
              ...
              (this._flagScale || this._flagLoaded) &&
                (this._renderer.scale instanceof W.Vector ||
                  (this._renderer.scale = new W.Vector()),
                this._scale instanceof W.Vector
      ...
      X.extend(e.prototype, W.Utils.Events, {
        ...
        setSize: function (e, t, i) {
          return (
            (this.width = e),
            (this.height = t),
            (this.ratio = X.isUndefined(i) ? r(this.ctx) : i),
        ...
        render: function () {
          var e = 1 === this.ratio;
          return (
            e || (this.ctx.save(), this.ctx.scale(this.ratio, this.ratio)),
  ...
  (function (W) {
      ...
      K = {
        ...
        group: {
          removeChild: function (e, t) {
            if (e.children)
              ...
              t.deleteTexture(e._renderer.texture), delete e._renderer.texture;
          },
          renderChild: function (e) {
            ...
            if (
              ((r || n) &&
                (this._renderer.matrix ||
                  (this._renderer.matrix = new W.Array(9)),
                this._matrix.toArray(!0, l),
                a(l, i._renderer.matrix, this._renderer.matrix),
                (this._renderer.scale = this._scale * i._renderer.scale),
              ...
              this._mask &&
                ...
                K[this._mask._renderer.type].render.call(
                  this._mask,
                  e,
                  t,
                  this
              ...
              (this._flagOpacity = i._flagOpacity || this._flagOpacity),
              (this._renderer.opacity =
                this._opacity * (i && i._renderer ? i._renderer.opacity : 1)),
              this._flagSubtractions)
            )
              for (var s = 0; s < this.subtractions.length; s++)
                K.group.removeChild(this.subtractions[s], e);
        ...
        path: {
          updateCanvas: function (e) {
            var t,
              ...
              R = m.length,
              E = R - 1;
            (v.width = Math.max(Math.ceil(e._renderer.rect.width * _), 1)),
              (v.height = Math.max(Math.ceil(e._renderer.rect.height * _), 1));
            var T,
            ...
            y.clearRect(0, 0, v.width, v.height),
              w &&
                (Y.isString(w)
                  ? (y.fillStyle = w)
                  : (K[w._renderer.type].render.call(w, y, e),
                    (y.fillStyle = w._renderer.effect))),
              x &&
                (Y.isString(x)
                  ? (y.strokeStyle = x)
                  : (K[x._renderer.type].render.call(x, y, e),
                    (y.strokeStyle = x._renderer.effect))),
              b && (y.lineWidth = b),
              k && (y.miterLimit = k),
              A && (y.lineJoin = A),
              C && (y.lineCap = C),
            ...
            for (var I = 0; I < m.length; I++) {
              ...
              switch (((f = H(U.x)), (g = H(U.y)), U.command)) {
                ...
                case W.Commands.arc:
                  ...
                  break;
                case W.Commands.curve:
                  (i = M ? z(I - 1, R) : Math.max(I - 1, 0)),
                    (t = M ? z(I + 1, R) : Math.min(I + 1, E)),
                    (r = m[i]),
                    (n = m[t]),
                    (c = (r.controls && r.controls.right) || W.Vector.zero),
                    (h = (U.controls && U.controls.left) || W.Vector.zero),
                    (l = r._relative
                      ? ((a = H(c.x + r.x)), H(c.y + r.y))
                      : ((a = H(c.x)), H(c.y))),
                    (o = U._relative
                      ? ((s = H(h.x + U.x)), H(h.y + U.y))
                      : ((s = H(h.x)), H(h.y))),
                    y.bezierCurveTo(a, l, s, o, f, g),
                    E <= I &&
                      M &&
                      ((n = T),
                      (d = (U.controls && U.controls.right) || W.Vector.zero),
                      (u = (n.controls && n.controls.left) || W.Vector.zero),
                      (l = U._relative
                        ? ((a = H(d.x + U.x)), H(d.y + U.y))
                        : ((a = H(d.x)), H(d.y))),
                      (o = n._relative
                        ? ((s = H(u.x + n.x)), H(u.y + n.y))
                        : ((s = H(u.x)), H(u.y))),
                      (f = H(n.x)),
                      (g = H(n.y)),
                      y.bezierCurveTo(a, l, s, o, f, g));
            ...
            M && y.closePath(),
              K.isHidden.test(w) ||
                ((p = w._renderer && w._renderer.offset) &&
                  (y.save(),
                  y.translate(-w._renderer.offset.x, -w._renderer.offset.y),
                  y.scale(w._renderer.scale.x, w._renderer.scale.y)),
                y.fill(),
                p && y.restore()),
              K.isHidden.test(x) ||
                ((p = x._renderer && x._renderer.offset) &&
                  (y.save(),
                  y.translate(-x._renderer.offset.x, -x._renderer.offset.y),
                  y.scale(x._renderer.scale.x, x._renderer.scale.y),
                  (y.lineWidth = b / x._renderer.scale.x)),
                y.stroke(),
                p && y.restore()),
              y.restore();
          },
            ...
            e.forEach(function (e) {
              ...
              (u = Math.min(l, u)),
                ...
                e.controls &&
                  ...
                  s &&
                    o &&
                    ((t = e._relative ? s.x + a : s.x),
                    (i = e._relative ? s.y + l : s.y),
                    (r = e._relative ? o.x + a : o.x),
                    (n = e._relative ? o.y + l : o.y),
                    t &&
                      i &&
                      r &&
                      n &&
          ...
          render: function (e, t, i) {
            ...
            var r = this.parent,
              ...
              o =
                this._flagVertices ||
                this._flagFill ||
                (this._fill instanceof W.LinearGradient &&
                  (this._fill._flagSpread ||
                    this._fill._flagStops ||
                    this._fill._flagEndPoints)) ||
                (this._fill instanceof W.RadialGradient &&
                  (this._fill._flagSpread ||
                    this._fill._flagStops ||
                ...
                (this._stroke instanceof W.LinearGradient &&
                  (this._stroke._flagSpread ||
                    this._stroke._flagStops ||
                    this._stroke._flagEndPoints)) ||
                (this._stroke instanceof W.RadialGradient &&
                  (this._stroke._flagSpread ||
                    this._stroke._flagStops ||
            ...
            return (
              (n || s) &&
                (this._renderer.matrix ||
                  (this._renderer.matrix = new W.Array(9)),
                this._matrix.toArray(!0, l),
                a(l, r._renderer.matrix, this._renderer.matrix),
                (this._renderer.scale = this._scale * r._renderer.scale)),
              o
                ? (this._renderer.rect || (this._renderer.rect = {}),
                  this._renderer.triangles ||
                    (this._renderer.triangles = new W.Array(12)),
                  (this._renderer.opacity =
                  ...
                  K.getTriangles(this._renderer.rect, this._renderer.triangles),
                  K.updateBuffer.call(K, e, this, t),
                  K.updateTexture.call(K, e, this))
                : (Y.isString(this._fill) || this._fill._update(),
                  Y.isString(this._stroke) || this._stroke._update()),
              !this._clip || i
                ? (e.bindBuffer(
                    e.ARRAY_BUFFER,
                    this._renderer.textureCoordsBuffer
                  ),
                  e.vertexAttribPointer(t.textureCoords, 2, e.FLOAT, !1, 0, 0),
                  e.bindTexture(e.TEXTURE_2D, this._renderer.texture),
                  e.uniformMatrix3fv(t.matrix, !1, this._renderer.matrix),
                  e.bindBuffer(e.ARRAY_BUFFER, this._renderer.buffer),
                  e.vertexAttribPointer(t.position, 2, e.FLOAT, !1, 0, 0),
        ...
        text: {
          updateCanvas: function (e) {
            var t = this.canvas,
              ...
              l = e.dashes;
            (t.width = Math.max(Math.ceil(e._renderer.rect.width * r), 1)),
              (t.height = Math.max(Math.ceil(e._renderer.rect.height * r), 1));
            var c,
              h,
              d,
              u,
            ...
            i.clearRect(0, 0, t.width, t.height),
              ...
              o &&
                (Y.isString(o)
                  ? (i.fillStyle = o)
                  : (K[o._renderer.type].render.call(o, i, e),
                    (i.fillStyle = o._renderer.effect))),
              n &&
                (Y.isString(n)
                  ? (i.strokeStyle = n)
                  : (K[n._renderer.type].render.call(n, i, e),
              ...
              K.isHidden.test(o) ||
                (o._renderer && o._renderer.offset
                  ? ((g = H(o._renderer.scale.x)),
                    ...
                    i.scale(g, p),
                    (c = e._size / o._renderer.scale.y),
                    (h = e._leading / o._renderer.scale.y),
                    (i.font = [
                      e._style,
                      e._weight,
                      H(c) + "px/",
                    ...
                    (d = o._renderer.offset.x / o._renderer.scale.x),
                    (u = o._renderer.offset.y / o._renderer.scale.y),
              ...
              K.isHidden.test(n) ||
                (n._renderer && n._renderer.offset
                  ? ((g = H(n._renderer.scale.x)),
                    ...
                    i.scale(g, p),
                    (c = e._size / n._renderer.scale.y),
                    (h = e._leading / n._renderer.scale.y),
                    (i.font = [
                      e._style,
                      e._weight,
                      H(c) + "px/",
                    ...
                    (d = n._renderer.offset.x / n._renderer.scale.x),
                    (u = n._renderer.offset.y / n._renderer.scale.y),
                    (f = s / n._renderer.scale.x),
                    (i.lineWidth = H(f)),
                    i.strokeText(e.value, H(d), H(u)),
                    i.restore())
            ...
            return (
              ...
              o
                ? (this._renderer.rect || (this._renderer.rect = {}),
                  ...
                  (this._renderer.opacity =
                    this._opacity * r._renderer.opacity),
                  K.text.getBoundingClientRect(this, this._renderer.rect),
                  K.getTriangles(this._renderer.rect, this._renderer.triangles),
                  K.updateBuffer.call(K, e, this, t),
                  K.updateTexture.call(K, e, this))
                : (Y.isString(this._fill) || this._fill._update(),
          ...
          render: function (e, t) {
            if (e.canvas.getContext("2d")) {
              ...
              if (
                ...
                this._renderer.effect = e.createPattern(i, this._repeat);
        ...
        updateTexture: function (e, t) {
          this[t._renderer.type].updateCanvas.call(K, t),
            t._renderer.texture && e.deleteTexture(t._renderer.texture),
            e.bindBuffer(e.ARRAY_BUFFER, t._renderer.textureCoordsBuffer),
            (t._renderer.texture = e.createTexture()),
            e.bindTexture(e.TEXTURE_2D, t._renderer.texture),
        ...
        updateBuffer: function (e, t, i) {
          Y.isObject(t._renderer.buffer) && e.deleteBuffer(t._renderer.buffer),
            (t._renderer.buffer = e.createBuffer()),
            e.bindBuffer(e.ARRAY_BUFFER, t._renderer.buffer),
            e.enableVertexAttribArray(i.position),
            e.bufferData(e.ARRAY_BUFFER, t._renderer.triangles, e.STATIC_DRAW),
            Y.isObject(t._renderer.textureCoordsBuffer) &&
              e.deleteBuffer(t._renderer.textureCoordsBuffer),
            (t._renderer.textureCoordsBuffer = e.createBuffer()),
            e.bindBuffer(e.ARRAY_BUFFER, t._renderer.textureCoordsBuffer),
            e.enableVertexAttribArray(i.textureCoords),
            e.bufferData(e.ARRAY_BUFFER, this.uv, e.STATIC_DRAW);
        },
        program: {
          create: function (t, e) {
            var i, r;
            if (
              ...
              throw (
                ...
                t.deleteProgram(i),
                new W.Utils.Error("unable to link program: " + r))
              );
            return i;
          },
        },
          ...
          create: function (e, t, i) {
            ...
            if (
              ...
              throw (
                ...
                e.deleteShader(r),
                new W.Utils.Error("unable to compile shader " + r + ": " + n))
              );
            return r;
          },
          types: {
    ...
    var t = (W[W.Types.webgl] = function (e) {
      ...
      (r = K.shaders.create(i, K.shaders.vertex, K.shaders.types.vertex)),
        (n = K.shaders.create(i, K.shaders.fragment, K.shaders.types.fragment)),
        ...
        (this.program.matrix = i.getUniformLocation(this.program, "u_matrix")),
    ...
    Y.extend(t, {
      ...
      Y.extend(t.prototype, W.Utils.Events, {
        ...
        setSize: function (e, t, i) {
          (this.width = e),
            (this.height = t),
            (this.ratio = Y.isUndefined(i) ? n(this.ctx) : i),
            (this.domElement.width = e * this.ratio),
            (this.domElement.height = t * this.ratio),
          ...
          return (
            this.ctx.uniform2f(r, e, t), this.trigger(W.Events.resize, e, t, i)
          );
        },
        render: function () {
          var e = this.ctx;
          return (
            this.overdraw || e.clear(e.COLOR_BUFFER_BIT | e.DEPTH_BUFFER_BIT),
            K.group.render.call(this.scene, e, this.program),
            (this._flagMatrix = !1),
            this
          );
        },
  ...
  (function (i) {
    var e = i.Utils,
      r = (i.Shape = function () {
        (this._renderer = {}),
          (this._renderer.flagMatrix = e.bind(r.FlagMatrix, this)),
          (this.isShape = !0),
          ...
          Object.defineProperty(e, "scale", {
            ...
            set: function (e) {
              this._scale instanceof i.Vector &&
                this._scale.unbind(i.Events.change, this._renderer.flagMatrix),
                (this._scale = e),
                this._scale instanceof i.Vector &&
                  this._scale.bind(i.Events.change, this._renderer.flagMatrix),
                (this._flagMatrix = !0),
                (this._flagScale = !0);
            },
          });
      ...
      e.extend(r.prototype, i.Utils.Events, {
        ...
        _update: function (e) {
          return (
            ...
            e && this.parent && this.parent._update && this.parent._update(),
            this
          );
        },
        flagReset: function () {
  ...
  (function (I) {
    ...
    var n = (I.Path = function (e, t, i, r) {
      I.Shape.call(this),
        ...
        (this._renderer.flagVertices = U.bind(n.FlagVertices, this)),
        (this._renderer.bindVertices = U.bind(n.BindVertices, this)),
        (this._renderer.unbindVertices = U.bind(n.UnbindVertices, this)),
        (this._renderer.flagFill = U.bind(n.FlagFill, this)),
        (this._renderer.flagStroke = U.bind(n.FlagStroke, this)),
        (this._renderer.vertices = []),
    ...
    function b(e, t) {
      ...
      for (var r = 0, n = 0; r < e._lengths.length; r++) {
        if (n + e._lengths[r] >= t)
          return (t -= n), Math.max(r - 1, 0) + t / e._lengths[r];
        n += e._lengths[r];
      }
      return -1;
    }
    ...
    U.extend(n, {
      ...
      BindVertices: function (e) {
        for (var t = e.length; t--; )
          e[t].bind(I.Events.change, this._renderer.flagVertices);
        this._renderer.flagVertices();
      },
      UnbindVertices: function (e) {
        for (var t = e.length; t--; )
          e[t].unbind(I.Events.change, this._renderer.flagVertices);
        this._renderer.flagVertices();
      },
      FlagFill: function () {
        this._flagFill = !0;
      ...
      MakeObservable: function (e) {
        I.Shape.MakeObservable(e),
          U.each(n.Properties.slice(2, 9), I.Utils.defineProperty, e),
          Object.defineProperty(e, "fill", {
            ...
            set: function (e) {
              (this._fill instanceof I.Gradient ||
                this._fill instanceof I.LinearGradient ||
                this._fill instanceof I.RadialGradient ||
                this._fill instanceof I.Texture) &&
                this._fill.unbind(I.Events.change, this._renderer.flagFill),
                (this._fill = e),
                (this._flagFill = !0),
                (this._fill instanceof I.Gradient ||
                  this._fill instanceof I.LinearGradient ||
                  this._fill instanceof I.RadialGradient ||
                  this._fill instanceof I.Texture) &&
                  this._fill.bind(I.Events.change, this._renderer.flagFill);
            },
          }),
          Object.defineProperty(e, "stroke", {
            ...
            set: function (e) {
              (this._stroke instanceof I.Gradient ||
                this._stroke instanceof I.LinearGradient ||
                this._stroke instanceof I.RadialGradient ||
                this._stroke instanceof I.Texture) &&
                this._stroke.unbind(I.Events.change, this._renderer.flagStroke),
                (this._stroke = e),
                (this._flagStroke = !0),
                (this._stroke instanceof I.Gradient ||
                  this._stroke instanceof I.LinearGradient ||
                  this._stroke instanceof I.RadialGradient ||
                  this._stroke instanceof I.Texture) &&
                  this._stroke.bind(I.Events.change, this._renderer.flagStroke);
            },
          }),
            ...
            set: function (e) {
              ...
              this._collection &&
                ...
                e instanceof I.Utils.Collection
                  ? (this._collection = e)
                  : (this._collection = new I.Utils.Collection(e || [])),
                this._collection
      ...
      U.extend(n.prototype, I.Shape.prototype, {
        ...
        getBoundingClientRect: function (e) {
          ...
          for (n = 1; n < r; n++)
            if (
              ...
              (s = this._renderer.vertices[n - 1]).controls && l.controls)
            ) {
              (o = s.relative
                ? t.multiply(
                ...
                : t.multiply(s.controls.right.x, s.controls.right.y, 1)),
                ...
                (a = l.relative
                  ...
                  : t.multiply(l.controls.left.x, l.controls.left.y, 1)),
        ...
        getPointAt: function (e, t) {
          for (
            var i,
              ...
              p,
              m,
              v = this.length * Math.min(Math.max(e, 0), 1),
            ...
            if (C + this._lengths[w] >= v) {
              this._closed
                ? ((i = I.Utils.mod(w, y)),
                  (r = I.Utils.mod(w - 1, y)),
                  0 === w && ((i = r), (r = w)))
                : ((i = w), (r = Math.min(Math.max(w - 1, 0), _))),
                (x = this.vertices[i]),
                (b = this.vertices[r]),
                (v -= C),
                (e = 0 !== this._lengths[w] ? v / this._lengths[w] : 0);
              break;
            }
            C += this._lengths[w];
          }
          ...
          (m = b.controls && b.controls.right),
            ...
            (s = I.Utils.getComponentOnCubicBezier(e, o, a, l, c)),
            (h = I.Utils.getComponentOnCubicBezier(e, d, u, f, g));
          ...
          return U.isObject(t)
            ? ((t.x = s),
              (t.y = h),
              U.isObject(t.controls) || I.Anchor.AppendCurveProperties(t),
              (t.controls.left.x = T),
              (t.controls.left.y = B),
            ...
            : (((n = new I.Anchor(
                ...
                F - s,
                O - h,
                this._curved ? I.Commands.curve : I.Commands.line
              )).t = e),
              n);
        },
        plot: function () {
          if (this.curved)
            return (
              I.Utils.getCurveFromPoints(this._collection, this.closed), this
            );
              ...
              function (e, t) {
                if (t <= 0 && !o) s = e;
                  ...
                  if (e.command === I.Commands.move)
                    return (
                      a.push(new I.Anchor(s.x, s.y)),
                      0 < t && (a[a.length - 1].command = I.Commands.line),
                      void (s = e)
                    );
                  var i = l(e, s, r);
                  (a = a.concat(i)),
                    U.each(i, function (e, t) {
                      t <= 0 && s.command === I.Commands.move
                        ? (e.command = I.Commands.move)
                        : (e.command = I.Commands.line);
                    }),
                    n <= t &&
        ...
        _updateLength: function (i, e) {
          ...
          var t = this.vertices.length,
            ...
            s = 0;
          return (
            U.isUndefined(this._lengths) && (this._lengths = []),
            U.each(
              this.vertices,
              function (e, t) {
                if (t <= 0 || e.command === I.Commands.move)
                  return (n = e), void (this._lengths[t] = 0);
                (this._lengths[t] = o(e, n, i)),
                  (this._lengths[t] = I.Utils.toFixed(this._lengths[t])),
                  (s += this._lengths[t]),
                  (n = e);
              },
              this
          ...
          if (this._flagVertices) {
            ...
            for (
              var e,
                ...
                o = this._closed,
                a = Math.min(this._beginning, this._ending),
                l = Math.max(this._beginning, this._ending),
                c = b(this, a * this._length),
                h = b(this, l * this._length),
                d = m(c),
                u = y(h),
                f = (this._renderer.vertices.length = 0);
              f < s;
              f++
            )
              this._renderer.collection.length <= f &&
                this._renderer.collection.push(new I.Anchor()),
                u < f && !t
                  ? ((n = this._renderer.collection[f]).copy(
                      this._collection[f]
                    ),
                    this.getPointAt(l, n),
                    (n.command = this._renderer.collection[f].command),
                    this._renderer.vertices.push(n),
                    (t = n),
                    (i = this._collection[f - 1]) &&
                      i.controls &&
                      (n.controls.right.clear(),
                      this._renderer.collection[f - 1].controls.right
                        .clear()
                        .lerp(i.controls.right, n.t)))
                  : d <= f &&
                    f <= u &&
                    ((n = this._renderer.collection[f].copy(
                      this._collection[f]
                    ...
                    this._renderer.vertices.push(n),
                    f === u && x(this, l)
                      ? ((t = n), !o && t.controls && t.controls.right.clear())
                      : f === d &&
                        x(this, a) &&
                        (((e = n).command = I.Commands.move),
                        !o && e.controls && e.controls.left.clear()));
            0 < d &&
              !e &&
              ((f = d - 1),
              (n = this._renderer.collection[f]).copy(this._collection[f]),
              this.getPointAt(a, n),
              ...
              (r = this._collection[f + 1]) &&
                ...
                this._renderer.collection[f + 1].controls.left
  ...
  (function (n) {
    var s = n.Path,
      ...
      r = (n.Rectangle = function (e, t, i, r) {
        s.call(
          this,
          [new n.Anchor(), new n.Anchor(), new n.Anchor(), new n.Anchor()],
          !0,
          !1,
          !0
        ),
          ...
          Object.defineProperty(e, "origin", {
            ...
            set: function (e) {
              this._origin &&
                ...
                (this._origin = e),
                this._origin.bind(n.Events.change, this._renderer.flagVertices),
                this._renderer.flagVertices();
            },
          });
      },
      ...
      i.extend(r.prototype, s.prototype, {
        ...
        _update: function () {
          if (this._flagWidth || this._flagHeight) {
            var e = this._width / 2,
              t = this._height / 2;
            (this.vertices[0].set(-e, -t).add(this._origin).command =
              n.Commands.move),
              (this.vertices[1].set(e, -t).add(this._origin).command =
                n.Commands.line),
              (this.vertices[2].set(e, t).add(this._origin).command =
                n.Commands.line),
              (this.vertices[3].set(-e, t).add(this._origin).command =
                n.Commands.line),
              this.vertices[4] &&
                (this.vertices[4].set(-e, -t).add(this._origin).command =
                  n.Commands.line);
          }
            ...
            for (var e = 0, t = this.vertices.length, i = t - 1; e < t; e++) {
              var r = (e / i) * f,
                ...
                h =
                  ...
                  (s = e === i ? 0 : s * v * m(r + g)),
                  this.vertices[e]);
              (h.command = 0 === e ? d.Commands.move : d.Commands.curve),
                h.set(o, a),
  ...
  (function (f) {
    ...
    o.extend(i, {
      ...
      o.extend(i.prototype, g.prototype, {
          ...
          if (this._flagRadius)
            for (var e = 0, t = this.vertices.length, i = t - 1; e < t; e++) {
              var r = (e / i) * p,
                ...
                d = e === i ? 0 : s * y(r + m),
                u = this.vertices[e];
              (u.command = 0 === e ? f.Commands.move : f.Commands.curve),
                u.set(o, a),
        ...
        flagReset: function () {
          return (
            (this._flagRadius = !1), g.prototype.flagReset.call(this), this
          );
        },
        clone: function (e) {
            ...
            for (var r = 0; r < t; r++) {
              ...
              i <= r
                ...
                (this.vertices[r].command =
                  0 === r ? a.Commands.move : a.Commands.line);
            }
          }
          ...
          if (
            ...
            for (var h = 0, d = l - 1; h < l; h++) {
              ...
              if (
                ...
                var y = (n * p) / Math.PI;
                (f.controls.left.x = y * Math.cos(g - w)),
                  (f.controls.left.y = y * Math.sin(g - w)),
                  (f.controls.right.x = y * Math.cos(g + w)),
                  (f.controls.right.y = y * Math.sin(g + w)),
                  1 === h && f.controls.left.multiplyScalar(2),
                  h === d && f.controls.right.multiplyScalar(2);
              }
              c++;
            }
            if (o) {
              for (
                s ? ((a[c].command = _.Commands.close), c++) : (d = --l - 1),
                  h = 0;
                h < l;
                h++
              )
                (u = h / d),
                  ...
                  (v = r * Math.sin(g)),
                  (e = _.Commands.curve),
                  h <= 0 && (e = s ? _.Commands.move : _.Commands.line),
                  (f.command = e),
                  (f.x = m),
                  (f.y = v),
                  f.controls.left.clear(),
          ...
          if (
            ...
            for (var r = 0; r < t; r++) {
              ...
              i <= r
                ...
                (this.vertices[r].command =
                  0 === r ? l.Commands.move : l.Commands.line);
            }
          }
    ...
    var l = a.Path,
      ...
      c = (a.RoundedRectangle = function (e, t, i, r, n) {
        ...
        l.call(this, s),
          (this.closed = !0),
          (this.automatic = !1),
          (this._renderer.flagRadius = o.bind(c.FlagRadius, this)),
          (this.width = i),
          (this.height = r),
          (this.radius = n),
          this._update(),
          ...
          Object.defineProperty(e, "radius", {
            ...
            set: function (e) {
              this._radius instanceof a.Vector &&
                this._radius.unbind(a.Events.change, this._renderer.flagRadius),
                (this._radius = e),
                this._radius instanceof a.Vector &&
                  this._radius.bind(a.Events.change, this._renderer.flagRadius),
                (this._flagRadius = !0);
            },
          });
      },
        ...
        _update: function () {
          if (this._flagWidth || this._flagHeight || this._flagRadius) {
            ...
            ((i = this.vertices[0]).x = -(s - e)),
              ...
              i.controls.left.clear(),
              i.controls.right.clear(),
              (i = this.vertices[9]).copy(this.vertices[8]);
          }
          return l.prototype._update.call(this), this;
        },
        flagReset: function () {
      ...
      h =
        ...
        (n.Text = function (e, t, i, r) {
          if (
            ...
            (this._renderer.flagFill = s.bind(n.Text.FlagFill, this)),
            (this._renderer.flagStroke = s.bind(n.Text.FlagStroke, this)),
            (this.value = e),
    ...
    s.extend(n.Text, {
      ...
      MakeObservable: function (e) {
        n.Shape.MakeObservable(e),
          s.each(n.Text.Properties.slice(0, 13), n.Utils.defineProperty, e),
          Object.defineProperty(e, "fill", {
            enumerable: !0,
            get: function () {
              return this._fill;
            ...
            set: function (e) {
              (this._fill instanceof n.Gradient ||
                this._fill instanceof n.LinearGradient ||
                this._fill instanceof n.RadialGradient ||
                this._fill instanceof n.Texture) &&
                this._fill.unbind(n.Events.change, this._renderer.flagFill),
                (this._fill = e),
                (this._flagFill = !0),
                (this._fill instanceof n.Gradient ||
                  this._fill instanceof n.LinearGradient ||
                  this._fill instanceof n.RadialGradient ||
                  this._fill instanceof n.Texture) &&
                  this._fill.bind(n.Events.change, this._renderer.flagFill);
            },
          }),
          Object.defineProperty(e, "stroke", {
            enumerable: !0,
            ...
            set: function (e) {
              (this._stroke instanceof n.Gradient ||
                this._stroke instanceof n.LinearGradient ||
                this._stroke instanceof n.RadialGradient ||
                this._stroke instanceof n.Texture) &&
                this._stroke.unbind(n.Events.change, this._renderer.flagStroke),
                (this._stroke = e),
                (this._flagStroke = !0),
                (this._stroke instanceof n.Gradient ||
                  this._stroke instanceof n.LinearGradient ||
                  this._stroke instanceof n.RadialGradient ||
                  this._stroke instanceof n.Texture) &&
                  this._stroke.bind(n.Events.change, this._renderer.flagStroke);
            },
          }),
          Object.defineProperty(e, "clip", {
            enumerable: !0,
  ...
  (function (r) {
    var n = r.Utils,
      s = (r.Stop = function (e, t, i) {
        (this._renderer = {}),
          ...
          (this.offset = n.isNumber(e) ? e : s.Index <= 0 ? 0 : 1),
          (this.opacity = n.isNumber(i) ? i : 1),
          (this.color = n.isString(t) ? t : s.Index <= 0 ? "#fff" : "white"),
          (s.Index = (s.Index + 1) % 2);
      });
    n.extend(s, {
      Index: 0,
      ...
      n.extend(s.prototype, r.Utils.Events, {
        ...
        flagReset: function () {
          return (
            (this._flagOffset = this._flagColor = this._flagOpacity = !1), this
          );
        },
      }),
      s.MakeObservable(s.prototype),
    ...
    var o = (r.Gradient = function (e) {
      (this._renderer = {}),
        ...
        (this._renderer.unbindStops = n.bind(o.UnbindStops, this)),
        (this.spread = "pad"),
        (this.stops = e);
    });
    n.extend(o, {
          ...
          Object.defineProperty(e, "stops", {
            ...
            set: function (e) {
              ...
              this._stops &&
                ...
                (this._stops = new r.Utils.Collection((e || []).slice(0))),
                this._stops.bind(r.Events.insert, t).bind(r.Events.remove, i),
                t(this._stops);
            },
          });
      },
      ...
      BindStops: function (e) {
        for (var t = e.length; t--; )
          e[t].bind(r.Events.change, this._renderer.flagStops),
            (e[t].parent = this);
        this._renderer.flagStops();
      },
      UnbindStops: function (e) {
        for (var t = e.length; t--; )
          e[t].unbind(r.Events.change, this._renderer.flagStops),
            delete e[t].parent;
        this._renderer.flagStops();
      },
    }),
    ...
    var a = o.Utils,
      l = (o.LinearGradient = function (e, t, i, r, n) {
        ...
        (this.left = new o.Vector().bind(o.Events.change, s)),
          (this.right = new o.Vector().bind(o.Events.change, s)),
  ...
  (function (s) {
    ...
    var a = (s.Texture = function (e, t) {
      if (
        ...
        (this._renderer.flagOffset = o.bind(a.FlagOffset, this)),
      ...
      o.isString(e) ? (this.src = e) : o.isElement(e) && (this.image = e),
        this._update();
    });
    o.extend(a, {
      ...
      Register: {
        ...
        img: function (t, i) {
          var r = function (e) {
              o.isFunction(t.image.removeEventListener) &&
                (t.image.removeEventListener("load", r, !1),
                t.image.removeEventListener("error", n, !1)),
                o.isFunction(i) && i();
            },
            n = function (e) {
              throw (
                (o.isFunction(t.image.removeEventListener) &&
                  (t.image.removeEventListener("load", r, !1),
                  t.image.removeEventListener("error", n, !1)),
                new s.Utils.Error("unable to load " + t.src))
              );
            };
        ...
        video: function (t, i) {
          var r = function (e) {
              t.image.removeEventListener("canplaythrough", r, !1),
                t.image.removeEventListener("error", n, !1),
          ...
          if (
            ((t._src = a.getAbsoluteURL(t._src)),
            t.image.addEventListener("canplaythrough", r, !1),
            t.image.addEventListener("error", n, !1),
            !t.image || !t.image.getAttribute("two-src"))
          ) {
      ...
      load: function (e, t) {
        ...
        e._flagImage &&
          (/canvas/i.test(r)
            ...
            : ((e._src = i.getAttribute("two-src") || i.src),
              a.Register[r](e, t))),
          e._flagSrc &&
      ...
      MakeObservable: function (e) {
        o.each(a.Properties, s.Utils.defineProperty, e),
          Object.defineProperty(e, "image", {
            ...
            set: function (e) {
              ...
              a.ImageRegistry.contains(t)
                ? (this._image = a.ImageRegistry.get(e.src))
                : (this._image = e),
                (this._flagImage = !0);
            },
          }),
          Object.defineProperty(e, "offset", {
            ...
            set: function (e) {
              this._offset &&
                this._offset.unbind(s.Events.change, this._renderer.flagOffset),
                (this._offset = e),
                this._offset.bind(s.Events.change, this._renderer.flagOffset),
                (this._flagOffset = !0);
            },
          }),
          Object.defineProperty(e, "scale", {
            ...
            set: function (e) {
              this._scale instanceof s.Vector &&
                this._scale.unbind(s.Events.change, this._renderer.flagScale),
                (this._scale = e),
                this._scale instanceof s.Vector &&
                  this._scale.bind(s.Events.change, this._renderer.flagScale),
                (this._flagScale = !0);
            },
          });
      },
            ...
            (this._flagSrc || this._flagImage) &&
              ...
              (this._flagSrc || this._flagImage) &&
                ...
                a.load(
                  ...
                  o.bind(function () {
                    (this.loaded = !0),
                      this.trigger(s.Events.change).trigger(s.Events.load);
                  }, this)
                ))),
            this._image &&
  ...
  (function (o) {
    var g = o.Utils,
      ...
      i = (o.Sprite = function (e, t, i, r, n, s) {
        a.call(
          this,
          [new o.Anchor(), new o.Anchor(), new o.Anchor(), new o.Anchor()],
          !0
        ),
          this.noStroke(),
          this.noFill(),
          e instanceof o.Texture
            ? (this.texture = e)
            : g.isString(e) && (this.texture = new o.Texture(e)),
        ...
        _update: function () {
          ...
          if (
            ...
            (e = (o = c.image.width) / h),
              ...
              this._playing &&
                0 < this._frameRate &&
                (g.isNaN(this._lastFrame) && (this._lastFrame = r - 1),
                (i = g.performance.now() - this._startTime),
                (n =
                  (1e3 * ((l = this._lastFrame + 1) - this._firstFrame)) /
                  this._frameRate),
                this._loop ? (i %= n) : (i = Math.min(i, n)),
                (s = g.lerp(this._firstFrame, l, i / n)),
                (s = Math.floor(s)) !== this._index &&
                  (this._index = s) >= this._lastFrame - 1 &&
                  this._onLastFrame &&
                  this._onLastFrame());
  ...
  (function (c) {
    var h = c.Utils,
      ...
      s = (c.ImageSequence = function (e, t, i, r) {
        n.call(
          this,
          [new c.Anchor(), new c.Anchor(), new c.Anchor(), new c.Anchor()],
          !0
        ),
          (this._renderer.flagTextures = h.bind(s.FlagTextures, this)),
          (this._renderer.bindTextures = h.bind(s.BindTextures, this)),
          (this._renderer.unbindTextures = h.bind(s.UnbindTextures, this)),
          this.noStroke(),
          this.noFill(),
    ...
    h.extend(s, {
      ...
      BindTextures: function (e) {
        for (var t = e.length; t--; )
          e[t].bind(c.Events.change, this._renderer.flagTextures);
        this._renderer.flagTextures();
      },
      UnbindTextures: function (e) {
        for (var t = e.length; t--; )
          e[t].unbind(c.Events.change, this._renderer.flagTextures);
        this._renderer.flagTextures();
      },
      MakeObservable: function (e) {
        d.MakeObservable(e),
          ...
          Object.defineProperty(e, "textures", {
            ...
            set: function (e) {
              ...
              this._textures &&
                ...
                (this._textures = new c.Utils.Collection((e || []).slice(0))),
                this._textures
      ...
      h.extend(s.prototype, d.prototype, {
        ...
        clone: function (e) {
          ...
          return (
            (t._loop = this._loop), this._playing && t.play(), e && e.add(t), t
          );
        },
        _update: function () {
          var e,
          ...
          return (
            ...
            this._playing && 0 < this._frameRate
              ? ((r = this._amount),
                h.isNaN(this._lastFrame) && (this._lastFrame = r - 1),
                (i = h.performance.now() - this._startTime),
                (n =
                  (1e3 * ((a = this._lastFrame + 1) - this._firstFrame)) /
                  this._frameRate),
                this._loop ? (i %= n) : (i = Math.min(i, n)),
                (o = h.lerp(this._firstFrame, a, i / n)),
                (o = Math.floor(o)) !== this._index &&
                  ...
                  (s = l[this._index]).loaded &&
                    ...
                    o >= this._lastFrame - 1 &&
                      this._onLastFrame &&
                      this._onLastFrame())))
              : (!this._flagIndex && this.fill instanceof c.Texture) ||
                ((s = l[this._index]).loaded &&
                  ((e = s.image.width),
                  (t = s.image.height),
                  this.width !== e && (this.width = e),
  ...
  (function (c) {
    ...
    function i(e, t) {
      var i,
        r = e.parent;
      return r === t
        ? (this.additions.push(e), void (this._flagAdditions = !0))
        : (r &&
            r.children.ids[e.id] &&
            ...
            0 <= (i = u.indexOf(r.additions, e))
              ...
              : (r.subtractions.push(e), (r._flagSubtractions = !0))),
          t
            ? ((e.parent = t),
            ...
            : (0 <= (i = u.indexOf(this.additions, e))
                ...
                : (this.subtractions.push(e), (this._flagSubtractions = !0)),
      ...
      MakeObservable: function (e) {
        ...
        Object.defineProperty(e, "opacity", {
          ...
          Object.defineProperty(e, "className", {
            ...
            set: function (e) {
              (this._flagClassName = this._className !== e),
                (this._className = e);
            },
          }),
          Object.defineProperty(e, "beginning", {
            ...
            set: function (e) {
              (this._flagBeginning = this._beginning !== e),
                (this._beginning = e);
            },
          }),
          Object.defineProperty(e, "ending", {
            ...
            n = function (e, t) {
              for (var i in e.children)
                e.children[i] instanceof t
                  ? r.push(e.children[i])
                  : e.children[i] instanceof c.Group && n(e.children[i], t);
              return r;
            };
          return n(this, e);
        },
        ...
        remove: function (e) {
          ...
          for (var r = 0; r < e.length; r++)
            e[r] &&
              ...
              this.children.splice(u.indexOf(this.children, e[r]), 1);
          return this;
        },
        getBoundingClientRect: function (e) {
          var t;
          ...
          if (this._flagBeginning || this._flagEnding)
            for (
              var e = Math.min(this._beginning, this._ending),
                t = Math.max(this._beginning, this._ending),
                i = this.length,
                r = 0,
                n = e * i,
                s = t * i,
    ...
    })(
      {
            ...
            !(function () {
              (c._inertiaScale = 4),
                ...
                (c.nextCategory = function () {
                  return (
                    (c._nextCategory = c._nextCategory << 1), c._nextCategory
                  );
                });
              var r = function (e, t) {
                (t = t || {}),
                  ...
                  h.rotate(e.vertices, e.angle, e.position),
                ...
                (e.render.fillStyle = e.render.fillStyle || i),
                  (e.render.strokeStyle = e.render.strokeStyle || "white"),
              ...
              (c.set = function (e, t, i) {
                var r;
                for (r in ("string" == typeof t && ((r = t), ((t = {})[r] = i)),
                t))
                  if (((i = t[r]), t.hasOwnProperty(r)))
                    switch (r) {
                      case "isStatic":
                        c.setStatic(e, i);
                        break;
                ...
                (c.setVertices = function (e, t) {
                  t[0].body === e
                    ...
                    (e.axes = f.fromVertices(e.vertices)),
                    (e.area = h.area(e.vertices)),
                    c.setMass(e, e.density * e.area);
                  var i = h.centre(e.vertices);
                  h.translate(e.vertices, i, -1),
                    c.setInertia(
                      e,
                      c._inertiaScale * h.inertia(e.vertices, e.mass)
                    ),
                    h.translate(e.vertices, e.position),
                    u.update(e.bounds, e.vertices, e.velocity);
                }),
                (c.setParts = function (e, t, i) {
                  ...
                  if (1 !== e.parts.length) {
                    ...
                    (e.area = l.area),
                      ((e.parent = e).position.x = l.centre.x),
                      (e.position.y = l.centre.y),
                      (e.positionPrev.x = l.centre.x),
                      (e.positionPrev.y = l.centre.y),
                      c.setMass(e, l.mass),
                ...
                (c.setPosition = function (e, t) {
                  ...
                  for (var r = 0; r < e.parts.length; r++) {
                    ...
                    (n.position.x += i.x),
                      ...
                      u.update(n.bounds, n.vertices, e.velocity);
                  }
                }),
                (c.setAngle = function (e, t) {
                  ...
                  for (var r = 0; r < e.parts.length; r++) {
                    var n = e.parts[r];
                    (n.angle += i),
                      h.rotate(n.vertices, i, e.position),
                      f.rotate(n.axes, i),
                      u.update(n.bounds, n.vertices, e.velocity),
                      0 < r &&
                        d.rotateAbout(n.position, i, e.position, n.position);
                  }
                }),
                (c.setVelocity = function (e, t) {
                  (e.positionPrev.x = e.position.x - t.x),
                    ...
                    (e.velocity.x = t.x),
                    (e.velocity.y = t.y),
                    (e.speed = d.magnitude(e.velocity));
                }),
                ...
                (c.scale = function (e, t, i, r) {
                  ...
                  for (var o = 0; o < e.parts.length; o++) {
                    ...
                    h.scale(a.vertices, t, i, r),
                      (a.axes = f.fromVertices(a.vertices)),
                      (a.area = h.area(a.vertices)),
                      c.setMass(a, e.density * a.area),
                      ...
                      c.setInertia(
                        a,
                        c._inertiaScale * h.inertia(a.vertices, a.mass)
                      ),
                      h.translate(a.vertices, {
                        x: a.position.x,
                        y: a.position.y,
                      }),
                      0 < o && ((n += a.area), (s += a.inertia)),
                      (a.position.x = r.x + (a.position.x - r.x) * t),
                      (a.position.y = r.y + (a.position.y - r.y) * i),
                      u.update(a.bounds, a.vertices, e.velocity);
                  }
                  1 < e.parts.length &&
                    ((e.area = n),
                    e.isStatic ||
                      (c.setMass(e, e.density * n), c.setInertia(e, s))),
                    e.circleRadius &&
                      (t === i
                        ? (e.circleRadius *= t)
                        : (e.circleRadius = null));
                ...
                (c.update = function (e, t, i, r) {
                  ...
                  (e.velocity.x = o * s * r + (e.force.x / e.mass) * n),
                    (e.velocity.y = a * s * r + (e.force.y / e.mass) * n),
                    (e.positionPrev.x = e.position.x),
                    (e.positionPrev.y = e.position.y),
                    (e.position.x += e.velocity.x),
                    (e.position.y += e.velocity.y),
                    (e.angularVelocity =
                      (e.angle - e.anglePrev) * s * r +
                  ...
                  for (var l = 0; l < e.parts.length; l++) {
                    var c = e.parts[l];
                    h.translate(c.vertices, e.velocity),
                      0 < l &&
                        ((c.position.x += e.velocity.x),
                        (c.position.y += e.velocity.y)),
                      0 !== e.angularVelocity &&
                        (h.rotate(c.vertices, e.angularVelocity, e.position),
                        f.rotate(c.axes, e.angularVelocity),
                        0 < l &&
                          d.rotateAbout(
                            c.position,
                            e.angularVelocity,
                ...
                (c._totalProperties = function (e) {
                  for (
                    ...
                    (t.mass += n),
                      (t.area += r.area),
                      (t.inertia += r.inertia),
                      (t.centre = d.add(t.centre, d.mult(r.position, n)));
                  }
          ...
          function (e, t, i) {
            ...
            (d.create = function (e) {
              ...
              (d.setModified = function (e, t, i, r) {
                if (
                  ((e.isModified = t),
                  i && e.parent && d.setModified(e.parent, t, i, r),
                  r)
                )
              ...
              (d.removeComposite = function (e, t, i) {
                ...
                if (
                  (-1 !== r &&
                    (d.removeCompositeAt(e, r), d.setModified(e, !0, !0, !1)),
                  i)
                )
                  for (var n = 0; n < e.composites.length; n++)
                    d.removeComposite(e.composites[n], t, !0);
                return e;
              }),
              (d.removeCompositeAt = function (e, t) {
                return (
                  e.composites.splice(t, 1), d.setModified(e, !0, !0, !1), e
                );
              }),
              ...
              (d.removeBody = function (e, t, i) {
                ...
                if (
                  (-1 !== r &&
                    (d.removeBodyAt(e, r), d.setModified(e, !0, !0, !1)),
                  i)
                )
                  for (var n = 0; n < e.composites.length; n++)
                    d.removeBody(e.composites[n], t, !0);
                return e;
              }),
              ...
              (d.removeConstraint = function (e, t, i) {
                ...
                if ((-1 !== r && d.removeConstraintAt(e, r), i))
                  for (var n = 0; n < e.composites.length; n++)
                    d.removeConstraint(e.composites[n], t, !0);
                return e;
              }),
              (d.removeConstraintAt = function (e, t) {
                return (
                  e.constraints.splice(t, 1), d.setModified(e, !0, !0, !1), e
                );
              }),
              ...
              (d.allBodies = function (e) {
                for (
                  ...
                  t = t.concat(d.allBodies(e.composites[i]));
                return t;
              }),
              (d.allConstraints = function (e) {
                for (
                  ...
                  t = t.concat(d.allConstraints(e.composites[i]));
                return t;
              }),
              (d.allComposites = function (e) {
                for (
                  ...
                  t = t.concat(d.allComposites(e.composites[i]));
                return t;
              }),
              ...
              (d.translate = function (e, t, i) {
                for (
                  var r = i ? d.allBodies(e) : e.bodies, n = 0;
                  n < r.length;
                  n++
                )
                  u.translate(r[n], t);
              ...
              (d.scale = function (e, t, i, r, n) {
                for (
                  var s = n ? d.allBodies(e) : e.bodies, o = 0;
                  o < s.length;
                  o++
                ) {
                  var a = s[o],
              ...
              for (var i = [], r = t.pairs.table, n = 0; n < e.length; n++) {
                ...
                if (
                  ((!s.isStatic && !s.isSleeping) ||
                    (!o.isStatic && !o.isSleeping)) &&
                  g.canCollide(s.collisionFilter, o.collisionFilter) &&
                  v.overlaps(s.bounds, o.bounds)
                )
                  for (
                    var a = 1 < s.parts.length ? 1 : 0;
                    a < s.parts.length;
                    a++
                  )
                    for (
                      var l = s.parts[a], c = 1 < o.parts.length ? 1 : 0;
                      c < o.parts.length;
                      c++
                    ) {
                      var h = o.parts[c];
            ...
            (v.create = function (e) {
              ...
              (v.update = function (e, t, i, r) {
                ...
                for (n = 0; n < t.length; n++) {
                  ...
                  if (
                    (!u.isSleeping || r) &&
                    !(
                      u.bounds.max.x < c.bounds.min.x ||
                      u.bounds.min.x > c.bounds.max.x ||
                      u.bounds.max.y < c.bounds.min.y ||
                      u.bounds.min.y > c.bounds.max.y
                    )
                  ) {
                        ...
                        for (o = g.startRow; o <= g.endRow; o++) {
                          ...
                          var p =
                            ...
                            m =
                              ...
                              o >= u.region.startRow &&
                              o <= u.region.endRow;
                          !p && m && m && a && v._bucketRemoveBody(e, a, u),
                            (u.region === f || (p && !m) || r) &&
                              (a || (a = v._createBucket(h, l)),
                              v._bucketAddBody(e, a, u));
                        }
                      (u.region = f), (d = !0);
                    }
                  }
              ...
              (v._createActivePairsList = function (e) {
                ...
                for (var n = 0; n < t.length; n++)
                  0 < (i = e.pairs[t[n]])[2] ? r.push(i) : delete e.pairs[t[n]];
                return r;
              });
          },
          {
          ...
          function (e, t, i) {
            ...
            (u.create = function (e, t) {
              ...
              (u.update = function (e, t, i) {
                ...
                if (
                  ((e.collision = t),
                  (e.inverseMass = o.inverseMass + a.inverseMass),
                  (e.friction = Math.min(o.friction, a.friction)),
                  (e.frictionStatic = Math.max(
                    o.frictionStatic,
                    a.frictionStatic
                  )),
                  (e.restitution = Math.max(o.restitution, a.restitution)),
            ...
            (c._pairMaxIdleLife = 1e3),
              ...
              (c.update = function (e, t, i) {
                var r,
                  ...
                  u = [];
                for (
                  c.length = 0, h.length = 0, o = d.length = 0;
                  o < t.length;
                  o++
                )
                  (r = t[o]).collided &&
                    ...
                    u.push(n),
                    (s = l[n])
                      ? (s.isActive ? d.push(s) : c.push(s), f.update(s, r, i))
                      : ((s = f.create(r, i)),
                        (l[n] = s),
                        c.push(s),
                        a.push(s)));
              ...
              (c.removeOld = function (e, t) {
                ...
                for (s = 0; s < o.length; s++)
                  (r = (i = o[s]).collision).bodyA.isSleeping ||
                  r.bodyB.isSleeping
                    ? (i.timeUpdated = t)
                    : t - i.timeUpdated > c._pairMaxIdleLife && l.push(s);
                for (s = 0; s < l.length; s++)
                  delete a[(i = o[(n = l[s] - s)]).id], o.splice(n, 1);
              }),
              (c.clear = function (e) {
                return (
                  (e.table = {}),
                ...
                for (var i = [], r = 0; r < e.length; r++) {
                  ...
                  if (c.contains(n.bounds, t))
                    for (
                      ...
                      var o = n.parts[s];
                      if (
                        c.contains(o.bounds, t) &&
                        a.contains(o.vertices, t)
                      ) {
                        i.push(n);
                        break;
                      }
            ...
            (N._restingThresh = 4),
              ...
              (N.solvePosition = function (e, t) {
                ...
                for (i = 0; i < e.length; i++)
                  (r = e[i]).isActive &&
                    !r.isSensor &&
                    ((s = (n = r.collision).parentA),
                    (o = n.parentB),
                    (a = n.normal),
                    (l = j.sub(
                      j.add(o.positionImpulse, o.position, d),
                      j.add(
                        s.positionImpulse,
                        j.sub(o.position, n.penetration, u),
                        f
                      ),
                      g
                    )),
                ...
                for (i = 0; i < e.length; i++)
                  (r = e[i]).isActive &&
                    ...
                    (o = n.parentB),
                    (a = n.normal),
                    (h = (r.separation - r.slop) * t),
                    (s.isStatic || o.isStatic) && (h *= 2),
                    s.isStatic ||
                      s.isSleeping ||
                      ((c = N._positionDampen / s.totalContacts),
                      (s.positionImpulse.x += a.x * h * c),
                      (s.positionImpulse.y += a.y * h * c)),
                    o.isStatic ||
                      o.isSleeping ||
                      ((c = N._positionDampen / o.totalContacts),
                      (o.positionImpulse.x -= a.x * h * c),
                      (o.positionImpulse.y -= a.y * h * c)));
              }),
                ...
                for (var t = 0; t < e.length; t++) {
                  ...
                  if (
                    ...
                    for (var r = 0; r < i.parts.length; r++) {
                      var n = i.parts[r];
                      s.translate(n.vertices, i.positionImpulse),
                        o.update(n.bounds, n.vertices, i.velocity),
                        (n.position.x += i.positionImpulse.x),
                        (n.position.y += i.positionImpulse.y);
                    }
                    (i.positionPrev.x += i.positionImpulse.x),
                      (i.positionPrev.y += i.positionImpulse.y),
                      j.dot(i.positionImpulse, i.velocity) < 0
                        ? ((i.positionImpulse.x = 0), (i.positionImpulse.y = 0))
                        : ((i.positionImpulse.x *= N._positionWarming),
                          (i.positionImpulse.y *= N._positionWarming));
                  }
                }
              }),
                    ...
                    for (
                      ...
                      (d = (h = n[i]).vertex),
                        ...
                        (0 === u && 0 === f) ||
                          ...
                          o.isStatic ||
                            o.isSleeping ||
                            ((g = j.sub(d, o.position, m)),
                            (o.positionPrev.x += p.x * o.inverseMass),
                            (o.positionPrev.y += p.y * o.inverseMass),
                            (o.anglePrev += j.cross(g, p) * o.inverseInertia)),
                          a.isStatic ||
                            a.isSleeping ||
                            ((g = j.sub(d, a.position, m)),
                  ...
                  if (h.isActive && !h.isSensor) {
                    ...
                    for (var y = 0; y < m.length; y++) {
                      var _ = m[y],
                        ...
                        S = j.add(
                          u.velocity,
                          j.mult(j.perp(b), u.angularVelocity),
                          o
                        ),
                        C = j.add(
                          f.velocity,
                          j.mult(j.perp(w), f.angularVelocity),
                          a
                        ),
                        A = j.sub(S, C, l),
                        k = j.dot(g, A),
                        ...
                        E = (1 + h.restitution) * k,
                        T =
                          G.clamp(h.separation + k, 0, 1) *
                          N._frictionNormalMultiplier,
                        B = M,
                        F = 1 / 0;
                      P > h.friction * h.frictionStatic * T * i &&
                        ((F = P), (B = G.clamp(h.friction * R * i, -F, F)));
                      var O = j.cross(b, g),
                        I = j.cross(w, g),
                        U =
                          v /
                          (u.inverseMass +
                            ...
                            f.inverseInertia * I * I);
                      if (
                        ((E *= U),
                        (B *= U),
                        k < 0 && k * k > N._restingThresh * i)
                      )
                        _.normalImpulse = 0;
                      else {
                        var L = _.normalImpulse;
                        (_.normalImpulse = Math.min(_.normalImpulse + E, 0)),
                          (E = _.normalImpulse - L);
                      }
                      if (M * M > N._restingThreshTangent * i)
                        _.tangentImpulse = 0;
                      else {
                        var V = _.tangentImpulse;
                        (_.tangentImpulse = G.clamp(
                          _.tangentImpulse + B,
                          -F,
                          F
                        )),
                          (B = _.tangentImpulse - V);
                      }
                      (r.x = g.x * E + p.x * B),
                        (r.y = g.y * E + p.y * B),
                        u.isStatic ||
                          u.isSleeping ||
                          ((u.positionPrev.x += r.x * u.inverseMass),
                          (u.positionPrev.y += r.y * u.inverseMass),
                          (u.anglePrev += j.cross(b, r) * u.inverseInertia)),
                        f.isStatic ||
                          f.isSleeping ||
                          ((f.positionPrev.x -= r.x * f.inverseMass),
                          (f.positionPrev.y -= r.y * f.inverseMass),
            ...
            (v.collides = function (e, t, i) {
              ...
              if (i) {
                var l = e.parent,
                  ...
                  h =
                    l.speed * l.speed +
                    l.angularSpeed * l.angularSpeed +
                    c.speed * c.speed +
                    c.angularSpeed * c.angularSpeed;
                (a = i && i.collided && h < 0.2), (o = i);
              } else
                o = {
                  collided: !1,
                  bodyA: e,
              ...
              if (i && a) {
                ...
                if (
                  ((s = v._overlapAxes(d.vertices, u.vertices, f)),
                  (o.reused = !0),
                  s.overlap <= 0)
                )
                ...
                if (
                  (r = v._overlapAxes(e.vertices, t.vertices, e.axes))
                    .overlap <= 0
                )
                  return (o.collided = !1), o;
                if (
                  (n = v._overlapAxes(t.vertices, e.vertices, t.axes))
                    .overlap <= 0
                )
                  return (o.collided = !1), o;
                r.overlap < n.overlap
              ...
              (o.bodyA = e.id < t.id ? e : t),
                ...
                (e = o.bodyA),
                (t = o.bodyB),
                _.dot(s.axis, _.sub(t.position, e.position)) < 0
                  ? (o.normal = {
                      x: s.axis.x,
                      y: s.axis.y,
                    })
                ...
                (o.penetration.x = o.normal.x * o.depth),
                (o.penetration.y = o.normal.y * o.depth);
              var g = v._findSupports(e, t, o.normal),
                p = [];
              if (
                (y.contains(e.vertices, g[0]) && p.push(g[0]),
                y.contains(e.vertices, g[1]) && p.push(g[1]),
                p.length < 2)
              ) {
                var m = v._findSupports(t, e, _.neg(o.normal));
                y.contains(t.vertices, m[0]) && p.push(m[0]),
                  p.length < 2 && y.contains(t.vertices, m[1]) && p.push(m[1]);
              }
              ...
              (v._overlapAxes = function (e, t, i) {
                for (
                  ...
                  if (
                    ...
                    (r = Math.min(s.max - o.min, o.max - s.min)) <= 0)
                  )
                    return (a.overlap = r), a;
                  r < a.overlap &&
                    ((a.overlap = r), (a.axis = n), (a.axisNumber = l));
                }
                return a;
              }),
              (v._projectToAxis = function (e, t, i) {
                for (
                  var r = _.dot(t[0], i), n = r, s = 1;
                  s < t.length;
                  s += 1
                ) {
                  var o = _.dot(t[s], i);
              ...
              (v._findSupports = function (e, t, i) {
                for (
                  ...
                  (n = c[d]),
                    (l.x = n.x - h.x),
                    (l.y = n.y - h.y),
                    (r = -_.dot(i, l)) < a && ((a = r), (s = n));
                return (
                  (n = c[0 <= s.index - 1 ? s.index - 1 : c.length - 1]),
                  (l.x = n.x - h.x),
                  (l.y = n.y - h.y),
                  (a = -_.dot(i, l)),
                  (o = n),
          ...
          function (e, t, i) {
            ...
            (b._warming = 0.4),
              ...
              (b.create = function (e) {
                ...
                (t.length = void 0 !== t.length ? t.length : n),
                  (t.id = t.id || h.nextId()),
                  (t.label = t.label || "Constraint"),
                  (t.type = "constraint"),
                  (t.stiffness = t.stiffness || (0 < t.length ? 1 : 0.7)),
              ...
              (b.solveAll = function (e, t) {
                ...
                for (i = 0; i < e.length; i += 1)
                  (n = !(r = e[i]).bodyA || (r.bodyA && r.bodyA.isStatic)),
                    (s = !r.bodyB || (r.bodyB && r.bodyB.isStatic)),
                    n || s || b.solve(e[i], t);
              }),
              (b.solve = function (e, t) {
                ...
                if (i || r) {
                  i &&
                    !i.isStatic &&
                    (w.rotate(n, i.angle - e.angleA, n), (e.angleA = i.angle)),
                    r &&
                      !r.isStatic &&
                      (w.rotate(s, r.angle - e.angleB, s),
                      (e.angleB = r.angle));
                  var o = n,
                    a = s;
                  if (
                    (i && (o = w.add(i.position, n)),
                    ...
                    if (e.damping) {
                      ...
                      (u = w.div(l, c)),
                        (g = w.sub(
                          (r && w.sub(r.position, r.positionPrev)) || x,
                          (i && w.sub(i.position, i.positionPrev)) || x
                        )),
                        (f = w.dot(u, g));
                    }
                    i &&
                      !i.isStatic &&
                      ((d = i.inverseMass / y),
                      (i.constraintImpulse.x -= v.x * d),
                      (i.constraintImpulse.y -= v.y * d),
                      (i.position.x -= v.x * d),
                      (i.position.y -= v.y * d),
                      e.damping &&
                        ((i.positionPrev.x -= e.damping * u.x * f * d),
                        (i.positionPrev.y -= e.damping * u.y * f * d)),
                      (h =
                        (w.cross(n, v) / _) *
                        b._torqueDampen *
                        i.inverseInertia *
                        (1 - e.angularStiffness)),
                      (i.constraintImpulse.angle -= h),
                      (i.angle -= h)),
                      r &&
                        !r.isStatic &&
                        ((d = r.inverseMass / y),
                        (r.constraintImpulse.x += v.x * d),
                        (r.constraintImpulse.y += v.y * d),
                        (r.position.x += v.x * d),
                        (r.position.y += v.y * d),
                        e.damping &&
                          ((r.positionPrev.x += e.damping * u.x * f * d),
                          (r.positionPrev.y += e.damping * u.y * f * d)),
                        (h =
                          (w.cross(s, v) / _) *
                          b._torqueDampen *
                          r.inverseInertia *
                          (1 - e.angularStiffness)),
                        (r.constraintImpulse.angle += h),
                        (r.angle += h));
                  }
                }
              }),
              (b.postSolveAll = function (e) {
                for (var t = 0; t < e.length; t++) {
                  var i = e[t],
                    r = i.constraintImpulse;
                  if (
                    !(i.isStatic || (0 === r.x && 0 === r.y && 0 === r.angle))
                  ) {
                    a.set(i, !1);
                    for (var n = 0; n < i.parts.length; n++) {
                      var s = i.parts[n];
                      o.translate(s.vertices, r),
                        0 < n && ((s.position.x += r.x), (s.position.y += r.y)),
                        0 !== r.angle &&
                          (o.rotate(s.vertices, r.angle, i.position),
                          c.rotate(s.axes, r.angle),
                          0 < n &&
                            w.rotateAbout(
                              s.position,
                              r.angle,
                        ...
                        l.update(s.bounds, s.vertices, i.velocity);
                    }
                    (r.angle *= b._warming),
                      (r.x *= b._warming),
                      (r.y *= b._warming);
                ...
                if (0 === i.button) {
                  if (r.bodyB) c.set(r.bodyB, !1), (r.pointA = i.position);
                    ...
                    for (var s = 0; s < t.length; s++)
                      if (
                        ((n = t[s]),
                        g.contains(n.bounds, i.position) &&
                          d.canCollide(n.collisionFilter, e.collisionFilter))
                      )
                        for (
                          var o = 1 < n.parts.length ? 1 : 0;
                          o < n.parts.length;
                          o++
                        ) {
                          var a = n.parts[o];
            ...
            (function (r) {
              ...
              (e.exports = l),
                (function () {
                  (l._nextId = 0),
                    ...
                    (l.extend = function (e, t) {
                      ...
                      for (var n = i; n < arguments.length; n++) {
                        ...
                        if (s)
                          for (var o in s)
                            r && s[o] && s[o].constructor === Object
                              ? e[o] && e[o].constructor !== Object
                                ? (e[o] = s[o])
                                : ((e[o] = e[o] || {}), l.extend(e[o], r, s[o]))
                              : (e[o] = s[o]);
                      }
                      return e;
                    }),
                  ...
                  var i = function () {
                    return (
                      (l._seed = (9301 * l._seed + 49297) % 233280),
                      l._seed / 233280
                    );
                  };
                  (l.colorToNumber = function (e) {
                    ...
                    (l.topologicalSort = function (e) {
                      var t = [],
                        ...
                        r = [];
                      for (var n in e)
                        i[n] || r[n] || l._topologicalSort(n, i, r, e, t);
                      return t;
                    }),
          ...
          function (e, t, i) {
            ...
            (g.create = function (e, t) {
              (t = (t = l.isElement(e) ? t : e) || {}),
                ((e = l.isElement(e) ? e : null) || t.render) &&
                  l.warn(
              ...
              return (
                ...
                (r.world = t.world || s.create(r.world)),
                (r.pairs = v.create()),
              ...
              (g.update = function (e, t, i) {
                ...
                for (
                  e.enableSleeping && p.update(c, s.timeScale),
                    g._bodiesApplyGravity(c, n.gravity),
                    g._bodiesUpdate(c, t, s.timeScale, i, n.bounds),
                    x.preSolveAll(c),
                    r = 0;
                ...
                x.postSolveAll(c),
                  (a = o.controller
                    ? (n.isModified && o.controller.clear(o),
                      o.controller.update(o, c, e, n.isModified),
                      o.pairsList)
                    : c),
                  n.isModified && _.setModified(n, !1, !1, !0);
                ...
                for (
                  v.update(u, d, f),
                    v.removeOld(u, f),
                    e.enableSleeping && p.afterCollisions(u.list, s.timeScale),
                    0 < u.collisionStart.length &&
                      y.trigger(e, "collisionStart", {
                  ...
                  m.solvePosition(u.list, s.timeScale);
                for (
                  m.postSolvePosition(c), x.preSolveAll(c), r = 0;
                  r < e.constraintIterations;
                  r++
                )
                  x.solveAll(h, s.timeScale);
                for (
                  x.postSolveAll(c), m.preSolveVelocity(u.list), r = 0;
                  r < e.velocityIterations;
                  r++
                )
                  m.solveVelocity(u.list, s.timeScale);
                return (
                  0 < u.collisionActive.length &&
                    y.trigger(e, "collisionActive", {
              ...
              (g._bodiesApplyGravity = function (e, t) {
                var i = void 0 !== t.scale ? t.scale : 0.001;
                if ((0 !== t.x || 0 !== t.y) && 0 !== i)
                  for (var r = 0; r < e.length; r++) {
                    var n = e[r];
                    n.isStatic ||
                      n.isSleeping ||
                      ((n.force.y += n.mass * t.y * i),
                      (n.force.x += n.mass * t.x * i));
                  }
              }),
        ...
        16: [
          function (e, t, i) {
            ...
            var c = e("./Common");
            (r.on = function (e, t, i) {
              for (var r, n = t.split(" "), s = 0; s < n.length; s++)
                (r = n[s]),
                  (e.events = e.events || {}),
                ...
                if (e.events) {
                  ...
                  for (var a = 0; a < r.length; a++)
                    if (((n = r[a]), (s = e.events[n]))) {
                      ((o = c.clone(i, !1)).name = n), (o.source = e);
          ...
          function (e, t, i) {
            ...
            (r.name = "matter-js"),
              ...
              (r.before = function (e, t) {
                return (
                  (e = e.replace(/^Matter./, "")), s.chainPathBefore(r, e, t)
                );
              }),
              (r.after = function (e, t) {
                return (
                  (e = e.replace(/^Matter./, "")), s.chainPathAfter(r, e, t)
                );
              });
          },
          {
          ...
          function (e, t, i) {
            ...
            (r.create = function (e) {
              ...
              return (
                ...
                (i.button = -1),
                (i.pixelRatio =
                  i.element.getAttribute("data-pixel-ratio") || 1),
                (i.sourceEvents = {
                  mousemove: null,
                  mousedown: null,
                  mouseup: null,
                ...
                (i.mousemove = function (e) {
                  ...
                  e.changedTouches && ((i.button = 0), e.preventDefault()),
                    (i.absolute.x = t.x),
                    (i.absolute.y = t.y),
              ...
              (r.setElement = function (e, t) {
                ...
                (e.element = t).addEventListener("mousemove", e.mousemove, i),
                  t.addEventListener("mousedown", e.mousedown, i),
                  t.addEventListener("mouseup", e.mouseup, i),
                  t.addEventListener("mousewheel", e.mousewheel, i),
                  t.addEventListener("DOMMouseScroll", e.mousewheel, i),
                  t.addEventListener("touchmove", e.mousemove, i),
                  t.addEventListener("touchstart", e.mousedown, i),
                  t.addEventListener("touchend", e.mouseup, i);
              }),
              ...
              (r._getRelativeMousePosition = function (e, t, i) {
                ...
                return (
                  (n = c
                    ? ((r = c[0].pageX - s.left - a), c[0].pageY - s.top - l)
                    : ((r = e.pageX - s.left - a), e.pageY - s.top - l)),
                  {
                    x: r / ((t.clientWidth / (t.width || t.clientWidth)) * i),
                    y:
                      n / ((t.clientHeight / (t.height || t.clientHeight)) * i),
                  }
                );
              });
          },
          ...
          function (e, t, i) {
            ...
            (a._registry = {}),
              (a.register = function (e) {
                if (
                  ...
                  var t = a._registry[e.name],
                    i = a.versionParse(e.version).number,
                    r = a.versionParse(t.version).number;
                  r < i
                    ? (l.warn(
                        "Plugin.register:",
                        a.toString(t),
              ...
              (a.resolve = function (e) {
                return a._registry[a.dependencyParse(e).name];
              }),
              ...
              (a.isFor = function (e, t) {
                ...
                return (
                  !e.for ||
                  (t.name === i.name && a.versionSatisfies(t.version, i.range))
                );
              }),
              (a.use = function (e, t) {
                if (
                        ...
                        ? a.isUsed(e, o.name) ||
                          ...
                          o.install
                            ...
                            : (l.warn(
                              ...
                              (o._warned = !0)),
                          o._warned
                            ? (n.push("ðŸ”¶ " + a.toString(o)),
                              delete o._warned)
                            : n.push("âœ… " + a.toString(o)),
                          e.used.push(o.name))
                        : n.push("âŒ " + r[s]);
                    }
              ...
              (a.dependencies = function (r, e) {
                ...
                if (!(t in (e = e || {}))) {
                  (r = a.resolve(r) || r),
                    (e[t] = l.map(r.uses || [], function (e) {
                      a.isPlugin(e) && a.register(e);
                      var t = a.dependencyParse(e),
                        i = a.resolve(e);
                      return (
                        i && !a.versionSatisfies(i.version, t.range)
                          ? (l.warn(
                              "Plugin.dependencies:",
                              a.toString(i),
                              "does not satisfy",
                ...
                (s.tick = function (e, t, i) {
                  ...
                  a.trigger(e, "beforeTick", o),
                    ...
                    1e3 <= i - e.counterTimestamp &&
                      ((e.fps =
                        e.frameCounter * ((i - e.counterTimestamp) / 1e3)),
                    ...
                    t.render &&
                      t.render.controller &&
                      (a.trigger(e, "beforeRender", o),
                      a.trigger(t, "beforeRender", o),
                      t.render.controller.world(t.render),
                      a.trigger(e, "afterRender", o),
                      a.trigger(t, "afterRender", o)),
              ...
              (h.update = function (e, t) {
                for (var i = t * t * t, r = 0; r < e.length; r++) {
                  ...
                  if (0 === n.force.x && 0 === n.force.y) {
                    ...
                    (n.motion = h._minBias * o + (1 - h._minBias) * a),
                      0 < n.sleepThreshold &&
                      n.motion < h._motionSleepThreshold * i
                        ? ((n.sleepCounter += 1),
                          n.sleepCounter >= n.sleepThreshold && h.set(n, !0))
                        : 0 < n.sleepCounter && (n.sleepCounter -= 1);
                  } else h.set(n, !1);
                }
              }),
                  ...
                  if (n.isActive) {
                    ...
                    if (
                      ...
                      var l = o.isSleeping && !o.isStatic ? o : a,
                        c = l === o ? a : o;
                      !l.isStatic &&
                        c.motion > h._motionWakeThreshold * i &&
                        h.set(l, !1);
                    }
                  }
                }
          ...
          function (e, t, i) {
            ...
            (g.rectangle = function (e, t, i, r, n) {
              ...
              (g.fromVertices = function (e, t, i, r, n, s, o) {
                ...
                for (
                  A || (A = M._requireGlobal("decomp", "poly-decomp")),
                    r = r || {},
                    l = [],
                    n = void 0 !== n && n,
                    s = void 0 !== s ? s : 0.01,
                  ...
                  if (((h = i[g]), (c = k.isConvex(h)) || !A))
                    (h = c ? k.clockwiseSort(h) : k.hull(h)),
                      l.push({
                        position: {
                          x: e,
                          y: t,
                      ...
                      if (R.overlaps(_.bounds, x.bounds)) {
                        ...
                        for (f = 0; f < _.vertices.length; f++)
                          for (p = 0; p < x.vertices.length; p++) {
                            var S = E.magnitudeSquared(
                                E.sub(b[(f + 1) % b.length], w[p])
                              ),
                              C = E.magnitudeSquared(
                                E.sub(b[f], w[(p + 1) % w.length])
                              );
                            S < 5 &&
                              C < 5 &&
                              ((b[f].isInternal = !0), (w[p].isInternal = !0));
                          }
                      }
                    }
                  }
          ...
          function (e, t, i) {
            ...
            (r.fromVertices = function (e) {
              ...
              (r.rotate = function (e, t) {
                if (0 !== t)
                  for (
                    var i = Math.cos(t), r = Math.sin(t), n = 0;
                    n < e.length;
                    n++
                  ) {
                    var s,
              ...
              (r.update = function (e, t, i) {
                ...
                for (var r = 0; r < t.length; r++) {
                  ...
                  n.x > e.max.x && (e.max.x = n.x),
                    n.x < e.min.x && (e.min.x = n.x),
                    n.y > e.max.y && (e.max.y = n.y),
                    n.y < e.min.y && (e.min.y = n.y);
                }
                i &&
                  (0 < i.x ? (e.max.x += i.x) : (e.min.x += i.x),
                  0 < i.y ? (e.max.y += i.y) : (e.min.y += i.y));
              }),
        ...
        27: [
          function (e, t, i) {
            ...
            (_.pathToVertices = function (e, t) {
              ...
              for (
                _._svgPathToAbsolute(e), n = e.getTotalLength(), a = [], i = 0;
                ...
                for (
                  ...
                  if (/[MLHVCSQTA]/.test(f))
                    ...
                    switch (
                      ...
                      case "c":
                        a.replaceItem(
                          e.createSVGPathSegCurvetoCubicAbs(l, c, r, n, s, o),
                          d
                        );
                        break;
                      case "s":
                        a.replaceItem(
                          e.createSVGPathSegCurvetoCubicSmoothAbs(l, c, s, o),
                          d
                        );
                        break;
                      case "q":
                        a.replaceItem(
                          e.createSVGPathSegCurvetoQuadraticAbs(l, c, r, n),
                          d
                        );
                        break;
                      case "t":
        ...
        29: [
          function (e, t, i) {
            ...
            (a.create = function (e, t) {
              ...
              (a.area = function (e, t) {
                for (var i = 0, r = e.length - 1, n = 0; n < e.length; n++)
                  (i += (e[r].x - e[n].x) * (e[r].y + e[n].y)), (r = n);
                return t ? i / 2 : Math.abs(i) / 2;
              }),
              (a.inertia = function (e, t) {
                for (var i, r, n = 0, s = 0, o = e, a = 0; a < o.length; a++)
                  (r = (a + 1) % o.length),
                    (n +=
                      (i = Math.abs(x.cross(o[r], o[a]))) *
                      (x.dot(o[r], o[r]) +
                        x.dot(o[r], o[a]) +
                        x.dot(o[a], o[a]))),
                    (s += i);
              ...
              (a.rotate = function (e, t, i) {
                if (0 !== t) {
                  for (
                    var r = Math.cos(t), n = Math.sin(t), s = 0;
                    s < e.length;
                    s++
                  ) {
                    var o = e[s],
              ...
              (a.contains = function (e, t) {
                for (var i = 0; i < e.length; i++) {
                  var r = e[i],
                    n = e[(i + 1) % e.length];
                  if (0 < (t.x - r.x) * (n.y - r.y) + (t.y - r.y) * (r.x - n.x))
                    return !1;
                }
                return !0;
              }),
                ...
                for (var s = [], o = 0; o < e.length; o++) {
                  ...
                  if (0 !== h) {
                    var d = x.normalise({
                      ...
                      p = x.normalise(x.mult(x.add(d, u), 0.5)),
                      m = x.sub(l, x.mult(p, f)),
                      v = i;
                    -1 === i && (v = 1.75 * Math.pow(h, 0.32)),
                      (v = b.clamp(v, r, n)) % 2 == 1 && (v += 1);
                    for (var y = Math.acos(x.dot(d, u)) / v, _ = 0; _ < v; _++)
                      s.push(x.add(x.rotate(g, y * _), m));
                  } else s.push(l);
                }
                return s;
              }),
              ...
              (a.isConvex = function (e) {
                ...
                for (t = 0; t < o; t++)
                  if (
                    ((r = (t + 2) % o),
                    (n = (e[(i = (t + 1) % o)].x - e[t].x) * (e[r].y - e[i].y)),
                    (n -= (e[i].y - e[t].y) * (e[r].x - e[i].x)) < 0
                      ? (s |= 1)
                      : 0 < n && (s |= 2),
                    3 === s)
                  )
              ...
              (a.hull = function (e) {
                ...
                for (
                  ...
                  for (
                    t = e[i];
                    2 <= n.length &&
                    x.cross3(n[n.length - 2], n[n.length - 1], t) <= 0;
                ...
                for (i = e.length - 1; 0 <= i; i -= 1) {
                  for (
                    t = e[i];
                    2 <= r.length &&
                    x.cross3(r[r.length - 2], r[r.length - 1], t) <= 0;
        ...
        30: [
          function (e, t, i) {
            ...
            (r.Body = e("../body/Body")),
              ...
              (r.Constraint = e("../constraint/Constraint")),
              (r.MouseConstraint = e("../constraint/MouseConstraint")),
            ...
            !(function () {
              ...
              "undefined" != typeof window &&
                ...
                (x.create = function (e) {
                  ...
                  return (
                    i.canvas &&
                      ((i.canvas.width = i.options.width || i.canvas.width),
                      (i.canvas.height = i.options.height || i.canvas.height)),
                    (i.mouse = e.mouse),
                    (i.engine = e.engine),
                    (i.canvas =
                      i.canvas || n(i.options.width, i.options.height)),
                    ...
                    1 !== i.options.pixelRatio &&
                      x.setPixelRatio(i, i.options.pixelRatio),
                ...
                (x.lookAt = function (e, t, i, r) {
                  ...
                  for (
                    ...
                    a &&
                      l &&
                      (a.x < n.min.x && (n.min.x = a.x),
                      l.x > n.max.x && (n.max.x = l.x),
                      a.y < n.min.y && (n.min.y = a.y),
                      l.y > n.max.y && (n.max.y = l.y));
                  }
                  ...
                  u < f ? (p = f / u) : (g = u / f),
                    ...
                    (e.bounds.max.x = n.min.x + c * g),
                    (e.bounds.min.y = n.min.y),
                    (e.bounds.max.y = n.min.y + h * p),
                    r &&
                      ((e.bounds.min.x += 0.5 * c - c * g * 0.5),
                      (e.bounds.max.x += 0.5 * c - c * g * 0.5),
                      (e.bounds.min.y += 0.5 * h - h * p * 0.5),
                      (e.bounds.max.y += 0.5 * h - h * p * 0.5)),
                    (e.bounds.min.x -= i.x),
                    (e.bounds.max.x -= i.x),
                    (e.bounds.min.y -= i.y),
                    (e.bounds.max.y -= i.y),
                ...
                (x.world = function (e) {
                  ...
                  if (
                    (S.trigger(e, "beforeRender", u),
                    e.currentBackground !== c && _(e, c),
                    ...
                    for (t = 0; t < l.length; t++) {
                      var g = l[t],
                        ...
                        v = g.pointA,
                        y = g.pointB;
                      p && (v = A.add(p.position, g.pointA)),
                        m && (y = A.add(m.position, g.pointB)),
                        v &&
                          y &&
                          (w.contains(e.bounds, v) ||
                            w.contains(e.bounds, y)) &&
                          d.push(g);
                    }
                  ...
                  !o.wireframes || (i.enableSleeping && o.showSleeping)
                    ? x.bodies(e, h, s)
                    : (o.showConvexHulls && x.bodyConvexHulls(e, h, s),
                      x.bodyWireframes(e, h, s)),
                    o.showBounds && x.bodyBounds(e, h, s),
                    (o.showAxes || o.showAngleIndicator) && x.bodyAxes(e, h, s),
                    o.showPositions && x.bodyPositions(e, h, s),
                    o.showVelocity && x.bodyVelocity(e, h, s),
                    o.showIds && x.bodyIds(e, h, s),
                    o.showSeparations && x.separations(e, i.pairs.list, s),
                    o.showCollisions && x.collisions(e, i.pairs.list, s),
                    o.showVertexNumbers && x.vertexNumbers(e, h, s),
                    o.showMousePosition && x.mousePosition(e, e.mouse, s),
                    x.constraints(d, s),
                    o.showBroadphase &&
                      i.broadphase.controller === C &&
                      x.grid(e, i.broadphase, s),
                    o.showDebug && x.debug(e, s),
                    o.hasBounds && x.endViewTransform(e),
                ...
                (x.debug = function (e, t) {
                  ...
                  if (500 <= r.timing.timestamp - (e.debugTimestamp || 0)) {
                    var a = "";
                    s.timing &&
                      (a += "fps: " + Math.round(s.timing.fps) + "    "),
                      (e.debugString = a),
                      (e.debugTimestamp = r.timing.timestamp);
                  }
                  if (e.debugString) {
                    (i.font = "12px Arial"),
                      o.wireframes
                    ...
                    for (
                      var l = e.debugString.split("\n"), c = 0;
                      c < l.length;
                      c++
                    )
                      i.fillText(l[c], 50, 50 + 18 * c);
                  }
                }),
                  ...
                  for (var i = t, r = 0; r < e.length; r++) {
                    ...
                    if (n.render.visible && n.pointA && n.pointB) {
                      var s,
                        ...
                        l = n.bodyB;
                      if (
                        ((s = a ? A.add(a.position, n.pointA) : n.pointA),
                        "pin" === n.render.type)
                      )
                        i.beginPath(),
                          i.arc(s.x, s.y, 3, 0, 2 * Math.PI),
                          i.closePath();
                      else {
                        if (
                          ((o = l ? A.add(l.position, n.pointB) : n.pointB),
                          i.beginPath(),
                          i.moveTo(s.x, s.y),
                          "spring" === n.render.type)
                        )
                          for (
                            var c,
                              h = A.sub(o, s),
                              d = A.perp(A.normalise(h)),
                              u = Math.ceil(m.clamp(n.length / 5, 12, 20)),
                              f = 1;
                            f < u;
                            f += 1
                          )
                      ...
                      n.render.lineWidth &&
                        ((i.lineWidth = n.render.lineWidth),
                        (i.strokeStyle = n.render.strokeStyle),
                        i.stroke()),
                        n.render.anchors &&
                          ((i.fillStyle = n.render.strokeStyle),
                          i.beginPath(),
                          i.arc(s.x, s.y, 3, 0, 2 * Math.PI),
                ...
                (x.bodyShadows = function (e, t, i) {
                  for (var r = i, n = (e.engine, 0); n < t.length; n++) {
                    ...
                    if (s.render.visible) {
                      ...
                      var a = s.position.x - 0.5 * e.options.width,
                        l = s.position.y - 0.2 * e.options.height,
                        c = Math.abs(a) + Math.abs(l);
                      (r.shadowColor = "rgba(0,0,0,0.15)"),
                        (r.shadowOffsetX = 0.05 * a),
                        (r.shadowOffsetY = 0.05 * l),
                        (r.shadowBlur = 1 + 12 * Math.min(1, c / 1e3)),
                        r.fill(),
                        (r.shadowColor = null),
                        ...
                        if ((n = r.parts[o]).render.visible) {
                          if (
                            ...
                            a.translate(n.position.x, n.position.y),
                              ...
                              a.drawImage(
                                d,
                                d.width * -h.xOffset * h.xScale,
                                d.height * -h.yOffset * h.yScale,
                                d.width * h.xScale,
                                d.height * h.yScale
                              ),
                              a.rotate(-n.angle),
                            ...
                            if (n.circleRadius)
                              ...
                              a.beginPath(),
                                a.moveTo(n.vertices[0].x, n.vertices[0].y);
                              for (var u = 1; u < n.vertices.length; u++)
                                !n.vertices[u - 1].isInternal || c
                                  ? a.lineTo(n.vertices[u].x, n.vertices[u].y)
                                  : a.moveTo(n.vertices[u].x, n.vertices[u].y),
                                  n.vertices[u].isInternal &&
                                    !c &&
                                    a.moveTo(
                                      n.vertices[(u + 1) % n.vertices.length].x,
                                      n.vertices[(u + 1) % n.vertices.length].y
                                    );
                ...
                (x.bodyConvexHulls = function (e, t, i) {
                  ...
                  for (o.beginPath(), n = 0; n < t.length; n++)
                    if ((r = t[n]).render.visible && 1 !== r.parts.length) {
                      for (
                ...
                (x.bodyBounds = function (e, t, i) {
                  ...
                  for (var s = 0; s < t.length; s++) {
                    if (t[s].render.visible)
                      for (
                        var o = t[s].parts, a = 1 < o.length ? 1 : 0;
                        a < o.length;
                        a++
                      ) {
                        var l = o[a];
                  ...
                  for (
                    ...
                    if (
                      ...
                      2 === r.activeContacts.length &&
                        ...
                        !0 === n.bodyA.isStatic
                          ? a.moveTo(h - 8 * n.normal.x, d - 8 * n.normal.y)
                          : a.moveTo(h + 8 * n.normal.x, d + 8 * n.normal.y),
                        a.lineTo(h, d);
                    }
                  l.wireframes
                ...
                (x.separations = function (e, t, i) {
                  ...
                  for (l.beginPath(), a = 0; a < t.length; a++)
                    if ((r = t[a]).isActive) {
                      ...
                      var h = 1;
                      (o = n.bodyB).isStatic || s.isStatic || (h = 0.5),
                        o.isStatic && (h = 0),
                        l.moveTo(o.position.x, o.position.y),
                        l.lineTo(
                          o.position.x - n.penetration.x * h,
                          o.position.y - n.penetration.y * h
                        ),
                        (h = 1),
                        o.isStatic || s.isStatic || (h = 0.5),
                        s.isStatic && (h = 0),
                        l.moveTo(s.position.x, s.position.y),
                        l.lineTo(
                          s.position.x + n.penetration.x * h,
                          s.position.y + n.penetration.y * h
                        );
                    }
                  c.wireframes
                ...
                (x.grid = function (e, t, i) {
                  ...
                  for (var n = m.keys(t.buckets), s = 0; s < n.length; s++) {
                    ...
                    if (!(t.buckets[o].length < 2)) {
                      var a = o.split(/C|R/);
                      r.rect(
                        0.5 + parseInt(a[1], 10) * t.bucketWidth,
                        0.5 + parseInt(a[2], 10) * t.bucketHeight,
                        t.bucketWidth,
                        t.bucketHeight
                      );
                    }
                ...
                (x.inspector = function (e, t) {
                  ...
                  if (s.hasBounds) {
                    ...
                    t.scale(1 / l, 1 / c),
                      t.translate(-n.bounds.min.x, -n.bounds.min.y);
                  }
          ...
          function (e, t, i) {
            ...
            !(function () {
              ...
              "undefined" != typeof window &&
                ...
                (_.clear = function (e) {
                  for (
                    var t = e.container, i = e.spriteContainer;
                    t.children[0];
                  ...
                  (e.textures = {}),
                    (e.sprites = {}),
                    (e.primitives = {}),
                    (e.sprites["bg-0"] = r) && t.addChildAt(r, 0),
                ...
                (_.setBackground = function (e, t) {
                  if (e.currentBackground !== t) {
                    ...
                    if (i) {
                      ...
                      (e.renderer.backgroundColor = n),
                        r && e.container.removeChild(r);
                    } else if (!r) {
                      var s = o(e, t);
                      ((r = e.sprites["bg-0"] =
                        new PIXI.Sprite(s)).position.x = 0),
                        (r.position.y = 0),
                        e.container.addChildAt(r, 0);
                    }
                    e.currentBackground = t;
                  }
                }),
                (_.world = function (e) {
                  var t,
                    ...
                    l = [];
                  s.wireframes
                    ? _.setBackground(e, s.wireframeBackground)
                    : _.setBackground(e, s.background);
                  ...
                  if (s.hasBounds) {
                    ...
                    for (t = 0; t < a.length; t++) {
                      var g = a[t],
                        ...
                        v = g.pointA,
                        y = g.pointB;
                      p && (v = w.add(p.position, g.pointA)),
                        m && (y = w.add(m.position, g.pointB)),
                        v &&
                          y &&
                          (x.contains(e.bounds, v) ||
                            x.contains(e.bounds, y)) &&
                          l.push(g);
                    }
                    n.scale.set(1 / d, 1 / u),
                      n.position.set(
                ...
                (_.constraint = function (e, t) {
                  ...
                  var i = t.bodyA,
                    ...
                    l = "c-" + t.id,
                    c = e.primitives[l];
                  c || (c = e.primitives[l] = new PIXI.Graphics()),
                    a.visible && t.pointA && t.pointB
                      ? (-1 === f.indexOf(o.children, c) && o.addChild(c),
                        c.clear(),
                        c.beginFill(0, 0),
                        c.lineStyle(
                          a.lineWidth,
                          f.colorToNumber(a.strokeStyle),
                          1
                        ),
                        i
                          ? c.moveTo(i.position.x + n.x, i.position.y + n.y)
                          : c.moveTo(n.x, n.y),
                        r
                          ? c.lineTo(r.position.x + s.x, r.position.y + s.y)
                          : c.lineTo(s.x, s.y),
                        c.endFill())
                      : c.clear();
                }),
                  ...
                  if (i.visible)
                    if (i.sprite && i.sprite.texture) {
                      var r = "b-" + t.id,
                        n = e.sprites[r],
                        s = e.spriteContainer;
                      n || (n = e.sprites[r] = c(e, t)),
                        -1 === f.indexOf(s.children, n) && s.addChild(n),
                        (n.position.x = t.position.x),
                        (n.position.y = t.position.y),
                        (n.rotation = t.angle),
                        (n.scale.x = i.sprite.xScale || 1),
                        (n.scale.y = i.sprite.yScale || 1);
                    } else {
                      var o = "b-" + t.id,
                        a = e.primitives[o],
                        l = e.container;
                      a ||
                        ((a = e.primitives[o] = h(e, t)).initialAngle =
                          t.angle),
                        -1 === f.indexOf(l.children, a) && l.addChild(a),
                        (a.position.x = t.position.x),
                        (a.position.y = t.position.y),
                        (a.rotation = t.angle - a.initialAngle);
                    }
                });
              var c = function (e, t) {
                  var i = t.render.sprite.texture,
                    ...
                    n = new PIXI.Sprite(r);
                  return (
                    (n.anchor.x = t.render.sprite.xOffset),
                    (n.anchor.y = t.render.sprite.yOffset),
                    n
                  );
                },
                h = function (e, t) {
                  ...
                  for (
                    ...
                    (i = t.parts[d]),
                      n.wireframes
                        ...
                        : (s.beginFill(o, 1), s.lineStyle(r.lineWidth, a, 1)),
                      s.moveTo(
                        i.vertices[0].x - t.position.x,
                        i.vertices[0].y - t.position.y
                      );
                    for (var u = 1; u < i.vertices.length; u++)
                      s.lineTo(
                        i.vertices[u].x - t.position.x,
                        i.vertices[u].y - t.position.y
                      );
                    s.lineTo(
                      i.vertices[0].x - t.position.x,
                      i.vertices[0].y - t.position.y
                      ...
                      (n.showAngleIndicator || n.showAxes) &&
                        (s.beginFill(0, 0),
                        n.wireframes ? s.lineStyle(1, h, 1) : s.lineStyle(1, l),
                        s.moveTo(
                          i.position.x - t.position.x,
                          i.position.y - t.position.y
                        ),
                        s.lineTo(
                          (i.vertices[0].x +
                ...
                o = function (e, t) {
                  var i = e.textures[t];
                  return (
                    i || (i = e.textures[t] = PIXI.Texture.fromImage(t)), i
                  );
                };
            })();
          },
...
function setupCopy() {
  for (
    var e = document.querySelector("#interactive__text").childNodes, t = 0;
    t < e.length;
    t++
  ) {
    var i = e[t];
  ...
  function a(e) {
    ...
    if (0 < e.childNodes.length) {
      ...
      for (
        ...
        (t = a(e.childNodes[i])), (s[0].value = s[0].value.concat(t));
    } else
      for (t = e.textContent.split(/\s+/i), r = 0; r < t.length; r++)
        (n = t[r]) && s.push(n);
    return s;
  }
}
...
function setupSymbols() {
  symbols.index = 0;
  for (
    var e = document.querySelectorAll("#interactive__images > *"), t = 0;
    t < e.length;
    t++
  ) {
  ...
  for (
    ...
    if (o.isWord || o.isLetter || o.isSymbol) {
      var a,
        ...
        h = o.entity;
      l
        ? ((l.size = r), (l.leading = n), (a = l.getBoundingClientRect(!0)))
        : ((a = {
        ...
        (vector.x = (two.width * h.position.x) / dimensions.width),
        (vector.y = (two.height * h.position.y) / dimensions.height),
...
function addSlogan() {
  for (
    ...
    Matter.Body.scale(p, i.width, i.height),
      Matter.Body.rotate(p, (Math.random() * Math.PI) / 16 - Math.PI / 32),
...
function addMouseInteraction() {
  ...
  function d() {
    Matter.Mouse.clearSourceEvents(n),
      r.removeEventListener("touchmove", n.mousemove, c),
      r.removeEventListener("touchstart", n.mousedown, c),
      r.removeEventListener("touchend", n.mouseup, c),
      (h = !1);
  }
  return (
    d(),
    ...
    r.addEventListener(
      ...
      function (e) {
        ...
        (a =
          ...
          e.touches[0].clientY < t.bottom)
          ? d()
          : h ||
            (n.mousedown(e),
            r.addEventListener("touchmove", n.mousemove, c),
            r.addEventListener("touchstart", n.mousedown, c),
            r.addEventListener("touchend", n.mouseup, c),
            (h = !0)),
          (o = !0),
          (i = null);
      },
    ...
    Matter.Events.on(e, "mousedown", function (e) {
    ...
    Matter.World.add(solver.world, e),
    e
  );
}
...
function injectSymbol(e) {
  var t = getFontSize() * symbolScalar,
    ...
    r = i.clone(),
    n = [];
  (r.isSymbol = !0), (r.symbol = getPathFromSVG(r)), (r.symbol.scale = 0.5);
  var s = e.x,
    o = e.y,
    a = {
